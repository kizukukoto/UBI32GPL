...
<head>
	...
	<title>My Net N900 Central<?php echo getDeviceUserDisplayName();?></title>
	...
	<div id="outerShell" style="position: fixed; width: 100%; height: 100%; overflow-y:auto">
            ...
            <div class="topGrad" >
                ...
                <div class="contentTables" style="width: 600px">
                    <span class='title'><?php echo gettext2("SHARES") ?> (<?php echo count($urlArray); ?>)</span>
					...
					<div id="appletWrap" >
						...
						<script>
						 var attributes = { code:'com.wd.nas4g.mapdrive.MapDrive.class',
						    archive:'<?php echo $appletUrl ?>/Admin/webapp/htdocs/MapDrive-1.0.jar?v=17',
						    width:'100%', height:'100%', MAYSCRIPT:'true', alt: "<?php echo gettext2("GET_JAVA"); ?>"};
						 var parameters =
							{
...
<script type="text/javascript" >
    ...
    $(document).ready(function() {
		...
		$(window).bind('beforeunload', function() {
			return '<?php echo gettext2("LOGOUT_WARNING") ?>';
		});
