...
class Mionet_registered{
	var $logObj;

    function Mionet_registered(){
    ...
    function get($urlPath, $queryParams=null, $ouputFormat='xml'){
        ...
        $result = $mioRegObj->getRegistered();

        if($result !== NULL){
            $xml = new NasXmlWriter();
            $xml->push('mionet_registered');
            $xml->element('registered', $result['registered']);
            $xml->element('mionet_username', $result['mionet_username']);
            $xml->pop();
            echo $xml->getXml();
    ...
    function put($urlPath, $queryParams=null, $ouputFormat='xml'){
		...
		$mioRegObj = new MionetRegistered();
        $result = $mioRegObj->modifyRegistered($changes);
