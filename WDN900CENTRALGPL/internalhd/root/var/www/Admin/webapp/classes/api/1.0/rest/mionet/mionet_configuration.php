...
require_once('mionetConfiguration.php');
require_once('logMessages.php');

class Mionet_configuration{
	var $logObj;

    function Mionet_configuration(){
    ...
    function get($urlPath, $queryParams=null, $ouputFormat='xml'){
        ...
        $mioConfigObj = new MionetConfiguration();
        $result = $mioConfigObj->getConfig();

        if($result !== NULL){
            $xml = new NasXmlWriter();
            $xml->push('mionet_configuration');
            $xml->element('enable_on_startup', $result['enable_on_startup']);
            $xml->pop();
            echo $xml->getXml();
    ...
    function put($urlPath, $queryParams=null, $ouputFormat='xml'){
		...
		$mioConfigObj = new MionetConfiguration();
        $result = $mioConfigObj->modifyConfig($changes);
