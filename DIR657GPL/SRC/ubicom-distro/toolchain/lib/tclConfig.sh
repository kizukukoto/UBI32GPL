...
# installed.
TCL_PREFIX='/scratch/ultra/toolchain-stable/install-2010-10-12-stable'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/scratch/ultra/toolchain-stable/install-2010-10-12-stable'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/scratch/ultra/toolchain-stable/install-2010-10-12-stable/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/scratch/ultra/toolchain-stable/install-2010-10-12-stable/include'
...
TCL_PACKAGE_PATH='/scratch/ultra/toolchain-stable/install-2010-10-12-stable/lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/scratch/ultra/toolchain-stable/install-2010-10-12-stable/lib -ltclstub8.4${TCL_DBGX}'
...
TCL_STUB_LIB_PATH='/scratch/ultra/toolchain-stable/install-2010-10-12-stable/lib/libtclstub8.4${TCL_DBGX}.a'
