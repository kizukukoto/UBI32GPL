...
function send_request(){
	...
	var addr_lifetime_msg = replace_msg(check_num_msg, "Address Lifetime", 1, 999999);
	var addr_lifetime_obj = new varible_obj(get_by_id("ipv6_dhcpd_lifetime").value, addr_lifetime_msg, 1, 999999, false);
	var adver_lifetime_msg = replace_msg(check_num_msg, "Advertisement Lifetime", 1, 999999);
          ...
          <div id=box_header>
             ...
             <script>show_words(IPV6_TEXT28)</script><br>
                    <br>
                        ...
                        <input name="button2" id="button2" type="button" class=button_submit value="" onclick="page_cancel('form1', 'adv_ipv6.asp');">
