...
function show_side_bar(page_num)
{
	...
	sidebar[4][0] = "<!--<li><div id=\"sidenavoff\"><script>show_words(usb_storage)</script></div></li>-->"
	sidebar[4][1] = "<!--<li><div id=\"sidenavon\"><a href=\"usb_storage.asp\" onclick=\"return jump_if();\"><script>show_words(usb_storage)</script></a></div></li>-->"
	sidebar[5][0] = "<li><div id=\"sidenavoff\"><script>show_words(_media_server)</script></div></li>"
	sidebar[5][1] = "<li><div id=\"sidenavon\"><a href=\"media_server.asp\" onclick=\"return jump_if();\"><script>show_words(_media_server)</script></a></div></li>"
