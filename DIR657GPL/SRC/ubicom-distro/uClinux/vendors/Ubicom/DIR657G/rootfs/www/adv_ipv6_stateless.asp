...
<script language="JavaScript">
    ...
    function onPageLoad()
    {
        ...
        set_checked("<% CmoGetCfg("ipv6_stateless_dns_enable","none"); %>", get_by_name("ipv6_dns_stateless_enable"));
    ...
    function disable_ipv6_stateless_auto_dns(){
        ...
        get_by_id("ipv6_stateless_primary_dns").disabled = fixIP[0].checked;
        get_by_id("ipv6_stateless_secondary_dns").disabled = fixIP[0].checked;
 	}
 	function disable_ipv6_dhcp_pd_chk(){
  	         get_by_id("ipv6_stateless_lan_ip").disabled = get_by_id("ipv6_dhcp_pd_chk").checked;
  	 }
...
function send_request(){
	...
	var adver_lifetime_obj = new varible_obj(get_by_id("ipv6_dhcp_adver_lifetime").value, adver_lifetime_msg , 1, 999999, false);
	...
	get_by_id("ipv6_stateless_dns_enable").value = get_checked_value(get_by_name("ipv6_dns_stateless_enable"));
	get_by_id("ipv6_wan_specify_dns").value= get_by_id("ipv6_stateless_dns_enable").value;
    ...
    if (!get_by_id("ipv6_dhcp_pd_chk").checked) {
		...
		if((check_mode == 0 || check_mode == 1) && enable_autoconfig == 1){
			...
			get_by_id("ipv6_ra_adv_valid_lifetime_l_one").value = get_by_id("ipv6_dhcp_adver_lifetime").value * 60 ;
			get_by_id("ipv6_ra_adv_prefer_lifetime_l_one").value = get_by_id("ipv6_dhcp_adver_lifetime").value * 60 ;
...
<body onload="onPageLoad();" topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
    ...
    <table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
        <tr>
                      ...
                      <td id=sidenav_container>
                        <div id=sidenav>
                          <UL>
                            ...
                            <LI><div id=sidenavoff>IPv6</div></LI>
		    ...
		    <input type="hidden" id="ipv6_stateless_dns_enable" name="ipv6_stateless_dns_enable" value="<% CmoGetCfg("ipv6_stateless_dns_enable","none"); %>">
                   ...
                   <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      ...
                      <td width="331">&nbsp; <select name="ipv6_w_proto" id="ipv6_w_proto" onChange=select_ipv6_wan_page(get_by_id("ipv6_w_proto").value);>
                        ...
                        <option value="ipv6_dhcp"><script>show_words(IPV6_TEXT33)</script></option>
                        <option value="ipv6_stateless" selected><script>show_words(TEXT001)</script></option>
...
<option value="link_local"><script>show_words(IPV6_TEXT37)</script></option>
            ...
            <div class=box id=wan_ipv6_settings>
                    ...
                    <table cellSpacing=1 cellPadding=1 width=525 border=0>
                        ...
                        <tr>
                          <td width="187" align=right class="duple"><script>show_words(wwa_sdns)</script> :</td>
                 ...
                 </div>      <div class=box id=lan_ipv6_settings>
