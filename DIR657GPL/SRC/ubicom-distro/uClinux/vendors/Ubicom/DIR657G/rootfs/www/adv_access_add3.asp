...
var DataArray = new Array();
    ...
    function del_row(idx)
    {
		...
		if(confirm((YM35) + DataArray[idx].Machine)){
    ...
    function check_duplicate(obj)
    {
        ...
        for(var i = 1; i < DataArray.length; i++){
            if(obj.toUpperCase() == DataArray[i].Machine.toUpperCase() && i != get_by_id("edit").value){
				alert(aa_alert_7);
                return false;
            }
			for (var j = 0; j < temp_dhcp_list.length; j++){
				var temp_data = temp_dhcp_list[j].split("/");
				if(temp_data.length > 1){
		            if((DataArray[i].Machine.toUpperCase() == temp_data[1].toUpperCase() && obj.toUpperCase() == temp_data[2].toUpperCase()) && i != get_by_id("edit").value){
						alert(aa_alert_7);
		                return false;
		            }
					if((DataArray[i].Machine.toUpperCase() == temp_data[2].toUpperCase() && obj.toUpperCase() == temp_data[1].toUpperCase()) && i != get_by_id("edit").value){
						alert(aa_alert_7);
		                return false;
		            }
				}
    ...
    <table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
        <tr>
           ...
           <input type="hidden" id="max_row" name="max_row" value="0">
            ...
            <div class=box>
            <h2>
              <script>show_words(_aa_wiz_s4_title)</script>
            </h2>
                <table width="670" id="add_table">
                  <tbody>
                      <tr>
					  	<td colspan="2" height="30"><P class="box_msg">
                      <script>show_words(_aa_wiz_s4_msg)</script>
                    </P></td>
                      </tr>
                      <tr>
					  	<td colspan="2" height="30"><p>
                      <script>show_words(_aa_wiz_s4_help)</script>
                    </p></td>
                      </tr>
                      <tr>

                  <td class="duple">
                    <script>show_words(aa_AT)</script>
                    :</td>
                        <td width="485">&nbsp;
                  ...
                  <td class="duple">
                    <script>show_words(aa_MAC)</script>
                    :</td>
                        <td width="485">&nbsp;
                      ...
                      <tr>
                        ...
                        <td width="485">
                            ...
                            <script>get_by_id("clear").value = _cancel;</script>
                        </td>
                      </tr>
                  </tbody>
                </table>
