...
<script language="JavaScript">
    ...
    function onPageLoad()
    {
        ...
        set_selectIndex("<% CmoGetCfg("wlan0_11b_txrate","none"); %>", get_by_id("11b_txrate"));
        set_selectIndex("<% CmoGetCfg("wlan0_11g_txrate","none"); %>", get_by_id("11g_txrate"));
        set_selectIndex("<% CmoGetCfg("wlan0_11n_txrate","none"); %>", get_by_id("11n_txrate"));
        set_selectIndex("<% CmoGetCfg("wlan0_11bg_txrate","none"); %>", get_by_id("11bg_txrate"));
        set_selectIndex("<% CmoGetCfg("wlan0_11gn_txrate","none"); %>", get_by_id("11gn_txrate"));
        set_selectIndex("<% CmoGetCfg("wlan0_11bgn_txrate","none"); %>", get_by_id("11bgn_txrate"));
        ...
        var psk_value = "<% CmoGetStatus("wlan0_psk_pass_phrase"); %>"
        var psk_tmp = psk_value.split("/");
        var psk_ps = decode(psk_tmp[0], psk_tmp[0].length);
        get_by_id("wlan0_psk_pass_phrase").value = psk_ps.substring(0, psk_tmp[1]);
        
        var temp_r0 = "<% CmoGetStatus("wlan0_radius0_ps"); %>";
        var Dr0 = temp_r0.split("/");
        	var radius_ps;
            get_by_id("radius_ip1").value=Dr0[0];
            get_by_id("radius_port1").value=Dr0[1];
        if (Dr0[3] > 0) {
            radius_ps = decode(Dr0[2], Dr0[2].length);
            get_by_id("radius_pass1").value = radius_ps.substring(0, Dr0[3]);
        }
        get_by_id("wlan0_eap_radius_server_0").value =  get_by_id("radius_ip1").value + "/" + 
                  get_by_id("radius_port1").value + "/" + get_by_id("radius_pass1").value;

        var temp_r1 = "<% CmoGetStatus("wlan0_radius1_ps"); %>";
        var Dr1 = temp_r1.split("/");
            get_by_id("radius_ip2").value=Dr1[0];
            get_by_id("radius_port2").value=Dr1[1];
        if (Dr1[3] > 0) {
        	radius_ps = decode(Dr1[2], Dr1[2].length);
            get_by_id("radius_pass2").value = radius_ps.substring(0, Dr1[3]);
        }
        get_by_id("wlan0_eap_radius_server_1").value =  get_by_id("radius_ip2").value + "/" + 
                  get_by_id("radius_port2").value + "/" + get_by_id("radius_pass2").value;
    ...
    function send_request()
    {
		...
		var form1_change = 1;
        if (wep_type_value == 1 && get_by_id("key1") != null) {        //WEP
        	if(get_by_id("key1").value != get_by_id("wlan0_wep64_key_1").value && get_by_id("key1").value != get_by_id("wlan0_wep128_key_1").value)
        		form1_change = 0;
        }
        if (!is_form_modified("form1") && form1_change && !confirm(_ask_nochange)) {
            return false;
        }

        var c_type = get_by_id("c_type").selectedIndex;
        var dot11_mode = get_by_id("dot11_mode").selectedIndex;
        ...
        if (wep_type_value == 1) {        //WEP
            ...
            if ((c_type == 0 || c_type == 2) && dot11_mode == 2 && get_by_id("w_enable").checked) {
                alert(MSG045);
                return false;
            }
            ...
            <td valign="top" id="maincontent_container">
               <div id="maincontent">
                  <div id="box_header">
                        ...
                        <script>show_words(bwl_Intro_1)</script><br><br>
            ...
            <tr>
              ...
              <td class="duple"><script>show_words(bwl_Mode)</script> :</td>
                                ...
                                <tr id="show_11b_txrate" style="display:none">
                                    ...
                                    <input type="hidden" id="wlan0_11b_txrate" name="wlan0_11b_txrate" value="<% CmoGetCfg("wlan0_11b_txrate","none"); %>">
                                    </td>
                                </tr>
                                <!-- 11g txrate -->
                                <tr id="show_11g_txrate" style="display:none">
                                    ...
                                    <input type="hidden" id="wlan0_11g_txrate" name="wlan0_11g_txrate" value="<% CmoGetCfg("wlan0_11g_txrate","none"); %>">
                                    </td>
                                </tr>
                                <!-- 11n txrate -->
                                <tr id="show_11n_txrate" style="display:none">
                                    ...
                                    <input type="hidden" id="wlan0_11n_txrate" name="wlan0_11n_txrate" value="<% CmoGetCfg("wlan0_11n_txrate","none"); %>">
                                    </td>
                                </tr>
                                <!-- 11b/g txrate -->
                                <tr id="show_11bg_txrate" style="display:none">
                                    ...
                                    <input type="hidden" id="wlan0_11bg_txrate" name="wlan0_11bg_txrate" value="<% CmoGetCfg("wlan0_11bg_txrate","none"); %>">
                                    </td>
                                </tr>
                                <!-- 11g/n txrate -->
                                <tr id="show_11gn_txrate" style="display:none">
                                    ...
                                    <input type="hidden" id="wlan0_11gn_txrate" name="wlan0_11gn_txrate" value="<% CmoGetCfg("wlan0_11gn_txrate","none"); %>">
                                    </td>
                                </tr>
                                <!-- 11b/g/n txrate -->
                                <tr id="show_11bgn_txrate" style="display:none">
                                    ...
                                    <input type="hidden" id="wlan0_11bgn_txrate" name="wlan0_11bgn_txrate" value="<% CmoGetCfg("wlan0_11bgn_txrate","none"); %>">
                                    </td>
                                </tr>
              ...
              <td width="340">&nbsp; <select name="auth_type" id="auth_type" onChange="ischeck_wps('auto');">
				  ...
				  <option value="share"><script>show_words(bws_Auth_2)</script></option>
                        ...
                        <p><script>show_words(bws_msg_WPA_2)</script></p>
                            ...
                            <table cellpadding="1" cellspacing="1" border="0" width="525">
                                ...
                                <tr>
                                    ...
                                    <td width="340">&nbsp;
                                        <input type="text" id="wlan0_gkey_rekey_time" name="wlan0_gkey_rekey_time" size="8" maxlength="5" value="<% CmoGetCfg("wlan0_gkey_rekey_time","none"); %>"> <script>show_words(bws_secs)</script>
                                    </td>
                                </tr>
                            </table>
                    </div>
                    <div class="box" id="show_wpa_psk" style="display:none">
                        ...
                        <p class="box_msg"><script>show_words(KR18)</script><script>show_words(KR19)</script></p>
                            <table cellpadding="1" cellspacing="1" border="0" width="525">
                                <tr>
                                    <td class="duple"><script>show_words(_psk)</script> :</td>
                                    <td width="340">&nbsp;
                                    	<input type="password" id="wlan0_psk_pass_phrase" name="wlan0_psk_pass_phrase" size="40" maxlength="64" onfocus="select();"></td>
                                </tr>
                            </table>
                    </div>
                    <div class="box" id="show_wpa_eap" style="display:none">
                        <h2><script>show_words(bws_EAPx)</script></h2>
                        <p class="box_msg"><script>show_words(bws_msg_EAP)</script><script>show_words(bws_RMAA)</script></p>
                            <table cellpadding="1" cellspacing="1" border="0" width="525">
                                <tr>
                                    <input type="hidden" id="wlan0_eap_radius_server_0" name="wlan0_eap_radius_server_0">
                                    ...
                                    <td width="340">&nbsp;<input id="wlan0_eap_reauth_period" name="wlan0_eap_reauth_period" size=10 value="<% CmoGetCfg("wlan0_eap_reauth_period","none"); %>"> <script>show_words(_minutes)</script></td>
                                </tr>
                                <tr>
