            ...
            if (get_by_id("name" + i).value != "") {
                ...
                if (protocol != 3) {
                    if (get_by_id("enable" + i).checked == true) {
                        ...
                        if (!check_virtual_port(i, get_by_id("public_portS" + i).value, get_by_id("ip" + i).value, _vs_port)) {
                            return false;
                        }
                        if (!check_virtual_port(i, get_by_id("private_portS" + i).value, get_by_id("ip" + i).value,_vs_port)) {
                            return false;
                        }
                    }
