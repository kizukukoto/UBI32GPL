		 ...
		 <div class=box id=lan_ipv6_settings>
	                ...
	                <table cellSpacing=1 cellPadding=1 width=525 border=0>
						...
						<td width="331">&nbsp;<input type=checkbox id="ipv6_dhcp_pd_chk" name="ipv6_dhcp_pd_chk" value="1" onclick="disable_ipv6_dhcp_pd_chk();"></td>
	                      ...
	                      <td width="331">&nbsp;
	                      	<input type=text id="ipv6_autodetect_lan_ip" name="ipv6_autodetect_lan_ip" size="30" maxlength="63" value="<% CmoGetCfg("ipv6_autodetect_lan_ip","none"); %>" onChange="set_ipv6_autoconf_range()">
	                      	<b>/64</b>
	                      </td>
			    </tr>
			    <tr>
