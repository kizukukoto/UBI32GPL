...
<script language="JavaScript">
    ...
    function onPageLoad()
    {
        ...
        var wlan0_vap1_psk_cipher_type = "<% CmoGetCfg("wlan0_vap1_psk_cipher_type","none"); %>";
              
        var psk_value = "<% CmoGetStatus("wlan0_vap1_psk_pass_phrase"); %>"
        var psk_tmp = psk_value.split("/");
        var psk_ps = decode(psk_tmp[0], psk_tmp[0].length);
        get_by_id("wlan0_vap1_psk_pass_phrase").value = psk_ps.substring(0, psk_tmp[1]);
        
        var temp_r0 = "<% CmoGetStatus("wlan0_vap1_radius0_ps"); %>";
        ...
        get_by_id("wlan0_vap1_eap_radius_server_0").value =  get_by_id("radius_ip1").value + "/" + 
                  get_by_id("radius_port1").value + "/" + get_by_id("radius_pass1").value;

        var temp_r1 = "<% CmoGetStatus("wlan0_vap1_radius1_ps"); %>";
        ...
        get_by_id("wlan0_vap1_eap_radius_server_1").value =  get_by_id("radius_ip2").value + "/" + 
        ...
        change_wep_key_fun();
        set_selectIndex("<% CmoGetCfg("wlan0_vap1_psk_cipher_type","none"); %>",get_by_id("c_type"));
        disable_wireless();
    ...
    function change_wep_key_fun()
    {
        ...
        var key2 = get_by_id("wlan0_vap1_wep" + key_num_array[key_length] + "_key_2").value;
        var key3 = get_by_id("wlan0_vap1_wep" + key_num_array[key_length] + "_key_3").value;
        var key4 = get_by_id("wlan0_vap1_wep" + key_num_array[key_length] + "_key_4").value;
    ...
    function send_request()
    {
        ...
        if (!(check_ssid("show_ssid") && ischeck_wps("auto"))) {
                return false;
        }
