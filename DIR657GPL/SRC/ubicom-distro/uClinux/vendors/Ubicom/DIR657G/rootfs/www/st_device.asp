...
<script>
    function onPageLoad()
    {
        ...
        if("<% CmoGetCfg("wlan0_11n_protection","none"); %>" == "auto")
        	get_by_id("wlan_11n_prot").innerHTML = "20/40";
        else
        	get_by_id("wlan_11n_prot").innerHTML = "<% CmoGetCfg("wlan0_11n_protection", "none"); %>";
    ...
    function set_wlan0_info(){
        var guest_enable= "<% CmoGetCfg("wlan0_vap1_enable","none"); %>";
        //var mac_0 = "<% CmoGetCfg("lan_mac","none"); %>";
        if(guest_enable == "0"){
            tmp_guest_enable = "NO";
        }else{
            tmp_guest_enable = "YES";
        }

        var security_0 = "<% CmoGetCfg("wlan0_security","none"); %>";
        var show_security_0 = security_0;
        if(security_0 == "wpa2auto_eap"){
            show_security_0 = "AUTO (WPA or WPA2) - EAP";
        }else if(security_0 == "wpa2auto_psk"){
            show_security_0 = "AUTO (WPA or WPA2) - PSK";
        }

            if(guest_enable_0 == 1){
                document.write("<tr><td><% CmoGetCfg("wlan0_ssid","none"); %></td><td>"+ tmp_guest_enable + "</td><td><% CmoGetCfg("lan_mac","none"); %></td><td>" + show_security_0 + "</td></tr>")
            }
    }
	...
	function set_dslite(net_status, aftr_address, aftr_enable)
	{
		...
		if(net_status == 1){
			...
			get_by_id("aftr_address").innerHTML = _none;
		}
    ...
    if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
		...
		*/
		...
		if (channel !="(null)" ) {
	        ...
	        get_by_id("show_wish_engine").style.display = "";
	        get_by_id("show_wps_enable").style.display = "";
	    	//get_by_id("show_guest").style.display = "none";
		    get_by_id("show_ssid_lst").style.display = "";
		    get_by_id("show_ssid_table0").style.display = "";
		}else{
			show_wlan0_string= _off;
    ...
    <table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
        <tr>
                    ...
                    <div class="box">
						<h2><script>show_words(_WAN)</script></h2>
                            <table cellpadding="1" cellspacing="1" border="0" width="525">
                                ...
                                <tr>
                                  <td class="duple">StreamEngine :</td>
                                  <td width="340">&nbsp;
            ...
            <tr id="show_wlan0_11n_protection">
              ...
              <td>&nbsp;
                <span id="wlan_11n_prot"></span>&nbsp;MHz
              </td>
            </tr>
            ...
            <tr id="show_ssid_table0">
              <td colspan="2" class="duple">
                ...
                if (tmp_guest_enable == "1") {                	
                  ...
                  document.write("<td width=128> <% CmoGetStatus("guestzone_mac"); %></td>");
