...
function disable_ipv6_dhcp_auto_dns(){
        ...
        get_by_id("ipv6_dhcp_primary_dns").disabled = fixIP[0].checked;
        get_by_id("ipv6_dhcp_secondary_dns").disabled = fixIP[0].checked;
}

function disable_ipv6_dhcp_pd_chk(){
        get_by_id("ipv6_dhcp_lan_ip").disabled = get_by_id("ipv6_dhcp_pd_chk").checked;
}
                   ...
                   <table cellSpacing=1 cellPadding=1 width=525 border=0>
                    <tr>
                      ...
                      <td width="331">&nbsp; <select name="ipv6_w_proto" id="ipv6_w_proto" onChange=select_ipv6_wan_page(get_by_id("ipv6_w_proto").value);>
                        ...
                        <option value="ipv6_dhcp" selected><script>show_words(IPV6_TEXT33)</script></option>
                        <option value="ipv6_stateless"><script>show_words(TEXT001)</script></option>
