      ...
      <td>
        <div class=box>
                ...
                <table class=formarea>
                    <tr>
                      <td width="334" height="81">
                        <UL>
                            <LI>Step 1: Configure your Internet Connection
                            <LI>Step 2: Configure your Wi-Fi Security
                            <LI>Step 3: Set your Password
                            <LI>Step 4: Select your Time Zone
                            <LI>Step 5: Save Setting
                        </UL>
                      </TD>
                    </tr>
                </table>
            ...
            <div id="wz_page_2" style="display:none">
                <h2 align="left">Step 1: Configure your Internet Connection</h2>
            ...
            <div id="wz_page_3" style="display:none">
                <h2 align="left">Step 1: Configure your Internet Connection</h2>
                <p class="box_msg">Please plug one end of the included Ethernet cable that
                came with your router into the port labeled INTERNET on the back of the router.
                Plug the other end of this cable into the Ethernet port on your modem.</p>
                <img src=network.jpg>
            </div><!-- wz_page_3 -->
            ...
            <div id="wz_page_7" style="display:none">
                ...
                <h2 align="left">Step 2: Configure your Wi-Fi Security</h2>
                <table class=formarea width="80%">
                    <tr>
                      <td width="10%">&nbsp;</td>
                      <td width="90%">
                        <br>
                        <P id="ssid_24g" class=box_msg>Give your Wi-Fi network a name.</P>
                        <P id="ssid_pass" class=box_msg>Give your Wi-Fi network a name and a password.
                        ...
                        <br><br>
                        <P id="pass_24g" class=box_msg>Give your Wi-Fi network a password.</P>
                        <P><b>Wi-Fi Password :</b></P>
                        <input type="text" id="wlan0_psk_pass_phrase" name="wlan0_psk_pass_phrase" size="40" maxlength="63">
                        (Between 8 and 63 characters)<br><br></td>
                    </tr>
                </table>
                ...
                <table class=formarea width="80%">
                    <tr>
                      <td width="10%">&nbsp;</td>
                      <td width="90%">
                        <P class=box_msg>Give your Wi-Fi network a name and a password. (<script>show_words(GW_WLAN_RADIO_1_NAME)</script>)</P>
                        <P><b>Wi-Fi <script>show_words(sd_NNSSID)</script> :</b></P>
            ...
            <div id="wz_page_8" style="display:none">
                <h2 align="left">Step 3: Set your Password</h2>
            ...
            <div id="wz_page_9" style="display:none">
                <h2 align="left">Step 4: Select your Time Zone</h2>
            ...
            <div id="wz_page_10" style="display:none">
                <h2 align="left"><!--script>_setupdone</script-->Setup Complete</h2>
                <P align="left" class=box_msg>Below is a detailed summary of your Wi-Fi security settings.
                Please print this page out, or write the information on a piece of paper, so you can configure
                the correct settings on your Wi-Fi devices.</P><br>
                ...
                <table class=formarea width="80%">
                  ...
                  <tr>
                    <td align="right"><b>Wi-Fi Password :</b><br><br></td>
                ...
                <br>
                <P align="left" class=box_msg>The Setup Wizard has completed.
                Click the Save Button to save your setting and reboot the router.</P>
            </div><!-- wz_page_10 -->
            </form>
