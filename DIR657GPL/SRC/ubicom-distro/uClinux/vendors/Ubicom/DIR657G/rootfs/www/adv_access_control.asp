    ...
    function set_policy_enable(idx)
    {
        if (confirm(msg[CHECK_ENABLE])) {
        	...
        	if(DataArray[idx].Enable == 1)
        		get_by_id("enable" + idx).checked = true;
        	else
        		get_by_id("enable" + idx).checked = false;
        }
    }
...
<input type="hidden" id="asp_temp_16" name="asp_temp_16" value="">  <!-- max_row -->
    ...
    <table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
        ...
        <input type="hidden" id="firewall_rule_119" name="firewall_rule_119" value="<% CmoGetCfg("firewall_rule_119","none"); %>">
           ...
           <input name="button2" id="button2"type="button" class=button_submit value="" onClick="page_cancel('form1', 'adv_access_control.asp');">
           <script>check_reboot();</script>
              ...
              <h2><script>show_words(_enable)</script></h2>
                <table width="525">
                    <tr>
                <td class="duple">
                  <script>show_words(aa_EAC)</script>
                  :</td>
                    ...
                    <tr id="show_policy" style="display:none">
                        <td class="duple">&nbsp;</td>
                        <td width="340">&nbsp;
                        <input type=button id=add_policy name=add_policy value="" onClick="send_next();">
          ...
          <td id=help_text><b>
            ...
            &hellip;</b> <p>
              <script>show_words(hhac_en)</script>
            </p>

            <p>
              <script>show_words(hhac_add)</script>
            </p>

            <p>
              <script>show_words(hhac_edit)</script>
            </p>

            <p>
              <script>show_words(hhac_delete)</script>
            </p>
