...
<script language="Javascript">
    ...
    function wz_verify_4()
    {
        ...
        if (wan_mode == "dhcpc") {
            ...
            if (pppoe_type[1].checked) {
                if (!is_ipv4_valid(get_by_id("wan_pppoe_ipaddr_00").value)) {
                    alert("<!--# tr tag='LS46' -->Invalid IP Address<!--# endtr -->");
                    return false;
                }
            }
	    ...
	    if(!check_servername(get_by_id("wan_pptp_server_ip").value)) {
            if (!is_ipv4_valid(get_by_id("wan_pptp_server_ip").value)) {
                alert(YM130);
	    ...
	    if(!check_servername(get_by_id("wan_l2tp_server_ip").value)) {
            if (!is_ipv4_valid(get_by_id("wan_l2tp_server_ip").value)) {
                alert(YM130);
        ...
        <div class=box>
            ...
            <div id="wz_page_3" style="display:none">
                ...
                <select size=1 id="time_zone" name="time_zone" onchange="time_zone_selector();">
                  ...
                  <option value="48"><font face=Arial><script>show_words(up_tz_39)</script></font></option>
                  ...
                  <option value="80"><font face=Arial><script>show_words(up_tz_45)</script></font></option>
                  ...
                  <option value="112"><font face=Arial><script>show_words(up_tz_54)</script></font></option>
                  <option value="128"><font face=Arial><script>show_words(up_tz_55)</script></font></option>
                  <option value="128"><font face=Arial><script>show_words(up_tz_56)</script></font></option>
                  ...
                  <option value="144"><font face=Arial><script>show_words(up_tz_62)</script></font></option>
                  ...
                  <option value="160"><font face=Arial><script>show_words(up_tz_69)</script></font></option>
