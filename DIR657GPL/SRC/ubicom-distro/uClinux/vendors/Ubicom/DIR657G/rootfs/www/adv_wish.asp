            ...
            for (var j = 0; j < rule_max_num; j++) {
                if (j != i) {
					...
					if (get_by_id("name" + i).value == get_by_id("name" + j).value) {
						alert("Rules"+i+" setting same as Rules"+j+".");
                        return false;
                    }
                    ...
                    //if ((rule_protocol == 1) || (rule_protocol == 2) || (rule_protocol == 3)) {
                        ...
                        // same as rule
                        alert("Rules"+i+" is setting same as Rules"+j+".");
                        return false;
                    //}
                }
            }
                    ...
                    <table bordercolor=#ffffff cellspacing=1 cellpadding=2 width=525 bgcolor=#dfdfdf border=1>
                        <script>
                                for(var i=0; i <rule_max_num ; i++){
                                        ...
                                        document.write("<td>"+_name+"<br><input id=name" + i + " name=name" + i +" type=text size=16 maxlength=15></td>");
