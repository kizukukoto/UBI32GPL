...
var	up_tz_56="(GMT+09:00) Irkutsk, Ulaan Bataar";
...
var	aa_AT_2="Others";
var     _copyright="Copyright &copy; 2004-2011 DLink, Inc.";
...
var     IPV6_TEXT13="Select this option if you require any wireless device attempting to communicate with the router to provide the encryption key needed to access the network before being allowed to communicate with the DIR-657.";
...
var     IPV6_TEXT15="The Key Types that are supported by the DIR-657 are HEX (Hexadecimal) and ASCII (American Standard Code for Information Interchange.) The Key Type can be changed to suit an existing wireless network or to customize your wireless network.";
...
var     IPV6_TEXT21="DIR-657 supports two different cipher types when WPA is used as the Security Type. These two options are TKIP (Temporal Key Integrity Protocol) and AES (Advanced Encryption Standard).";
...
var     IPV6_TEXT25="This will be needed by your wireless clients in order to communicate with your DIR-657, when PSK is selected. Enter 8 to 63 alphanumeric characters. Be sure to write this Passphrase down as you will need to enter it on any other wireless devices you are trying to add to your network.";
