				...
				<form id="form1" name="form1" method="post" action="apply.cgi">
	                ...
	                <tr align="left">
	                  ...
	                  <td colspan="2" class=form_label>
	                  	<div class="style1"><b><script>show_words(sd_NNSSID)</script> :</b>
	                ...
	                <tr align="left">
	                  ...
	                  <td colspan="2" class=form_label>
	                  	<div class="style1"><script>show_words(wwz_auto_assign_key)</script></div>
	                  </TD>
	                </tr>
	                <tr align="left">
	                  <td width="20">&nbsp;</td>
	                ...
	                <tr align="left" style="display:none">
	                  <td width="20"><INPUT type="checkbox" id="is_WPA" name="is_WPA" checked="true"></td>
	                  <td colspan="2" class=form_label>
	                  	<div class="style1">
