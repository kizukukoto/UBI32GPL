...
/*	LiteImage *image;
	...
	lite_load_image(image, "/share/LiTE/lcdrouter/theme/sky/menu/networkmap.png");
...
*/
	res = lite_new_image(LITE_BOX(app->window), &rect, NULL, &image);
	lite_load_image(image, "/share/LiTE/lcdrouter/theme/sky/menu/networkmap.png");
