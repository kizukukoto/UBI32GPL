...
typedef size_t (*RelayHook)(struct dhcpMessage *, size_t) FAST_FUNC;
...
size_t udhcp_relay_hook_ssid(struct dhcpMessage *p, size_t packlen) FAST_FUNC;
size_t  udhcp_relay_hook_putenv_ip_mac(struct dhcpMessage *p, size_t ret) FAST_FUNC;
