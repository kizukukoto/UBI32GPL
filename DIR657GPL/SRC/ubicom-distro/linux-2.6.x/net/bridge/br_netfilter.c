...
/*
 * This flag is used to keep trackof bridge filter state. Wiht it
 * it is possible to enable/dsiable bridge netfilter at runtime.
 */
static int nf_br_initialized = 0;
#endif
