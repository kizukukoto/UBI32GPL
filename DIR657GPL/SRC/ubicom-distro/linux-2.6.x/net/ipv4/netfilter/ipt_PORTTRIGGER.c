...
{
	//BUG_ON(!spin_is_locked(&nf_conntrack_lock));
	spin_is_locked(&porttrigger_lock);
 ...
 */
static unsigned int porttrigger_nat(struct sk_buff *skb, const struct xt_target_param *par)
{
 ...
 */
static unsigned int porttrigger_forward(struct sk_buff *skb, const struct xt_target_param *par)
{
 ...
 */
static unsigned int porttrigger_target(struct sk_buff *skb, const struct xt_target_param *par)
{
	const struct ipt_porttrigger_info *info = par->targinfo;
	enum ip_conntrack_info ctinfo;
        struct nf_conn *ct;
