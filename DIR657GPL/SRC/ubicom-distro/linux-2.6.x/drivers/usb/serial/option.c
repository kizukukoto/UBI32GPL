...
/*	Date:	2009-01-15
*	Name:	jimmy huang
*	Reason: Patched for 3G USB DWM-652
*	Note:	Add DLINK info below
*/
#define DLINK_VENDOR_ID                          0x1186//0x8611
#define DLINK_PRODUCT_DWM_652                    0x3E04//0x043E
//#define HUAWEI_VENDOR_ID		0x12d1
//#define HUAWEI_PRODUCT_E220		0x1003

//DWM-152 uses the VID_07D1&PID_3E01 as USB device identifier in modem mode.
//DWM-156 uses the VID_07D1&PID_3E02 as USB device identifier in modem mode.
#define QUANTA_VENDOR_ID		0x07d1
#define QUANTA_PRODUCT_DWM_152		0x3E01
#define QUANTA_PRODUCT_DWM_156		0x3E02
#define QUANTA_PRODUCT_DWM_152_156_A3	0x7E11
...
//	{ USB_DEVICE(HUAWEI_VENDOR_ID, HUAWEI_PRODUCT_E220) },
	...
	{ USB_DEVICE(QUANTA_VENDOR_ID, QUANTA_PRODUCT_DWM_152) },
	{ USB_DEVICE(QUANTA_VENDOR_ID, QUANTA_PRODUCT_DWM_156) },
	{ USB_DEVICE(QUANTA_VENDOR_ID, QUANTA_PRODUCT_DWM_152_156_A3) },	
...
#define SWAP16(X) X>>16|X<<16	
	...
	*/
	if (dev->descriptor.idVendor == SWAP16(DLINK_VENDOR_ID))
	{
...
*	Name:	jimmy huang
*	Reason: Patched for 3G USB DWM-652
*	Note:	Mofified the codes above to new codes below
*/
	.probe      = option_probe,
