...
irqreturn_t xhci_irq(struct usb_hcd *hcd)
{
	...
	UBI_DMA_CHECK_READY(xhci);
	if (XHCI_DEBUG)
		UBI_DMA_INVALIDATE(trb, sizeof(*trb));	
		...
		unsigned int ep_index, struct urb *urb)
{
	...
	UBI_DMA_INVALIDATE(out_ctx, sizeof(*out_ctx));
...
int xhci_address_device(struct usb_hcd *hcd, struct usb_device *udev)
{
	...
	UBI_DMA_INVALIDATE(virt_dev->out_ctx, sizeof(*virt_dev->out_ctx));
...
#include "xhci-ubi32.c"
#define	PLATFORM_DRIVER		ubi32_xhci_driver
#endif
