...
//DWM-152 or DWM-156 uses the VID_07D1 & PID_A800 as USB device identifierin mass storage mode.
...
UNUSUAL_DEV( 0x07d1, 0xa800, 0x0000, 0x0000,
		"D-Link",
		"DWM-152 3.5G",
		US_SC_DEVICE, US_PR_DEVICE, dwm_152_156_swich_port_init,
		0 ),
//DWM-152A3 or DWM-156A3
UNUSUAL_DEV( 0x07d1, 0x7e11, 0x0000, 0x0000,
		"D-Link",
		"DWM-152_156_A3 3.5G",
		US_SC_DEVICE, US_PR_DEVICE, NULL,
		US_FL_IGNORE_DEVICE ),
