...
/*	Date:	2009-07-28
*	Name:	Nick Chou
*	Reason: Patched for 3G USB HUAWEI E220	
*       This places the HUAWEI E220 devices in multi-port mode
*/
...
int dwm_152_156_swich_port_init(struct us_data *us)
{
       int result = 0;
       
       //request => 0xff, requesttype => 0xC0, 
       //value   => 0x00, index       => 0x00, 
       //data    => Null, size        => 0x0 , 
       //int timeout => 1000															
       //Change DWM-152/DWM-156 to modem mode
       result = usb_control_msg(us->pusb_dev, usb_sndctrlpipe(us->pusb_dev, 0),
               0xff, 0xc0, 
               0x0000, 0x0000, NULL, 0x0000, 1000);
       return (result ? 0 : -1);
}
