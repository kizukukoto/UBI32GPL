...
struct profile_map {
	u16_t start;		/* start page number of segment, relative to start of DRAM (Max 256 MB on IP7K or 1 GB on IP8K) */
	u16_t type_size;	/* type (4 bits) of the segment and size (12 bits) in (pages). A size of 0 means 4K pages */
};
