...
#define PCI_DEV_ADDR_SIZE ((unsigned long)(1 << 26))
...
extern int ubi32_pcie_addr_to_port(void __iomem *addr);
extern void ubi32_pcie_dma_lock(int port, unsigned long *flags);
extern void ubi32_pcie_dma_unlock(int port, unsigned long *flags);
...
#define page_to_phys(page)      ((((page) - mem_map) << PAGE_SHIFT) + PAGE_OFFSET)
