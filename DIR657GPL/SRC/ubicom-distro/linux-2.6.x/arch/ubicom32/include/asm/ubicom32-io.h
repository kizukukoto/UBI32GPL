...
extern unsigned int ubi32_xhci_readl(const volatile void __iomem *addr, const volatile void __iomem *base);
extern void ubi32_xhci_writel(unsigned int val, const volatile void __iomem *addr, const volatile void __iomem *base);
extern void ubi32_xhci_dma_ready(void __iomem *fbase);
#endif
