...
#elif defined(IP8000)
# define UBICOM32_ARCH_VERSION 5
#else
# error "Unknown UBICOM32 silicon"
#endif
...
#if defined(IP5000) || defined(IP7000) || defined(IP8000)
...
#define OCMC_PARITY_CNTL	0x04			/* IP8000 only */
...
# define RA			(IO_BASE + 0x00000000)
# define RB			(IO_BASE + 0x00004000)
# define RC			(IO_BASE + 0x00008000)
# define RD			(IO_BASE + 0x0000c000)
# define RE			(IO_BASE + 0x00010000)
# define RF			(IO_BASE + 0x00014000)
# define RG			(IO_BASE + 0x00018000)
# define RH			(IO_BASE + 0x0001c000)
# define RI			(IO_BASE + 0x00020000)
# define RJ			(IO_BASE + 0x00024000)
# define RK			(IO_BASE + 0x00028000)
# define RL			(IO_BASE + 0x0002c000)
# define RM			(IO_BASE + 0x00030000)
# define RN			(IO_BASE + 0x00034000)
# define RO			(IO_BASE + 0x00038000)
# define RP			(IO_BASE + 0x0003c000)
# define RQ			(IO_BASE + 0x00040000)
# define RR			(IO_BASE + 0x00044000)
# define RS			(IO_BASE + 0x00048000)
# define RT			(IO_BASE + 0x0004c000)
# define RU			(IO_BASE + 0x00050000)
# define RLATCH			(IO_BASE + 0x00ff0000)	// For latched output only
...
# define PG0 (IO_IOM_BASE + 0x00)
# define PG1 (IO_IOM_BASE + 0x20)
# define PG2 (IO_IOM_BASE + 0x40)
# define PG3 (IO_IOM_BASE + 0x60)
# define PG4 (IO_IOM_BASE + 0x80)
# define PG5 (IO_IOM_BASE + 0xA0)
# define PG6 (IO_IOM_BASE + 0xC0)
#endif
...
/*
 * Convert a pointer, i.e. RB to a struct ubicom32_gpio_port
 */
