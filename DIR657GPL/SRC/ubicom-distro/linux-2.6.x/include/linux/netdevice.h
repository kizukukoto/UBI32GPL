...
#define HAVE_TX_TIMEOUT
	...
	int is_guest_zone; // net_device is Guest Zone ??
	int support_route; // 1=>Guest Zone support Routing between LAN, 0=>Disable Routing between LAN
	int support_share_port; //Guest Zone support NetWork USB Utility (Sliex or KCodes)??
#endif	
