...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
    ...
    <table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
        <tr>
            ...
            <div class=box>
            <h2>
              <script>show_words(_aa_wiz_s5_title)</script>
            </h2>
            <P class="box_msg">
              <script>show_words(_aa_wiz_s5_msg1)</script>
            </P>
                <table width="670" class=formarea>
                  <tbody>
                      <tr>
                  <td class="duple">
                    <script>show_words(_aa_method)</script>
                    :</td>
                        <td width="485">&nbsp;
                ...
                <table width="670" id="show_filter" style="display:none">
                  <tbody>
                      <tr>
                  <td class="duple">
                    <script>show_words(_aa_apply_web_filter)</script>
                    :</td>
                        <td width="485">&nbsp;
                      ...
                      <tr>
                  <td class="duple">
                    <script>show_words(_aa_apply_port_filter)</script>
                    :</td>
                        <td width="485">&nbsp;
