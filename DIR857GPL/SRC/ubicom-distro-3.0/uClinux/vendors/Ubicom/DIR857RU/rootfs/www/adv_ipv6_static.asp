...
//                var static_prefix_length = get_by_id("ipv6_static_prefix_length_value").value;
			...
			static_prefix_length = get_by_id("ipv6_static_prefix_length").value;
                ...
                {
                        get_by_id("ipv6_static_wan_ip").value = "<% CmoGetCfg("ipv6_static_wan_ip","none"); %>";
                        get_by_id("ipv6_static_prefix_length").value = "<% CmoGetCfg("ipv6_static_prefix_length","none"); %>";
          ...
          <div id=box_header>
             ...
             <script>show_words(IPV6_TEXT28);</script><br>
                    <br>
                        ...
                        <input name="button2" id="button2" type="button" class=button_submit value="" onclick="return page_cancel_1('form1', 'adv_ipv6_static.asp');">
