...
<script language="Javascript">
	...
	var auto_length = 32;
	function onPageLoad(){
		get_by_id("show_ssid_0").value = get_by_id("asp_temp_34").value;
		get_by_id("show_ssid_1").value = get_by_id("asp_temp_67").value;
	...
	function send_request(){
		...
		if(login_who== "user"){
			...
			return false;
				...
				if (get_by_id("show_ssid_0").value == ""){
				    alert(_badssid);
				    return false;
				}else{
			...
			//if(get_by_id("set_5g").checked){
				if (get_by_id("show_ssid_1").value == ""){
				    alert(_badssid);
				    return false;
				}else{
            ...
            <div align="center">
              <p class="box_msg" align="left"><script>show_words(wwz_wwl_intro_s3_1)</script></p>
				...
				<form id="form1" name="form1" method="post" action="apply.cgi">
					...
					<input type="hidden" id="asp_temp_67" name="asp_temp_67" value="<% CmoGetCfg("wlan1_ssid","none"); %>">
	                ...
	                <!--tr align="left">
	                  ...
	                  <td colspan="2" class=form_label>
	                  	<div class="style1">
			        <script>show_words(wwz_wpa_support)</script>
			        	</div>
	                  </TD>
	                </tr-->
					<tr>
					<td class="box_msg" colspan="3"><br><script>show_words(wwl_s3_note_2)</script><br><br></td>
					</tr>
	                <tr align="center">
	                  <td colspan="3">
                          <input type="button" class="button_submit"id="prev_b" name="prev_b" value="" onClick="window.location.href='wizard_wireless.asp'">
                          <input type="button" class="button_submit"id="next_b" name="next" value="" onClick="send_request()">
