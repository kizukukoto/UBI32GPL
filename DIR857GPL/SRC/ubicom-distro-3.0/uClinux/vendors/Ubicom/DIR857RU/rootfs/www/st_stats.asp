...
function show_stats(status){
	...
	var wlan1_stats = (get_by_id("wlan1_stats").value).split("/");
...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
			...
			<input type="hidden" id="wlan1_stats" name="wlan1_stats" value="<% CmoGetStatus("wlan1_ifconfig_info"); %>">
