        ...
        <tr>
            ...
            <td valign="top" id="maincontent_container">
                <div id="maincontent">
                    ...
                    <table borderColor=#ffffff cellSpacing=1 cellPadding=2 width=525 bgColor=#dfdfdf border=1 style="word-wrap:break-word;word-break:break-all;">
                      <tbody>
                        <tr>
                        ...
                        <script>
                            ...
                            for (var i = 0; i < temp_entry.length; i++){
                                ...
                                if(entry.length > 1){
                                    document.write("<tr><td width=\"120\">" + entry[0] + "</td><td>" + entry[2] + "</td></tr>");
                                }
                            }
                        </script>
                      </tbody>
              ...
              <p>&nbsp;</p>
                ...
                <input type="hidden" id="html_response_page" name="html_response_page" value="back.asp">
                <input type="hidden" id="html_response_message" name="html_response_message" value="">
                <script>get_by_id("html_response_message").value = _success;</script>
                <input type="hidden" id="html_response_return_page" name="html_response_return_page" value="st_log.asp">
                </form>
