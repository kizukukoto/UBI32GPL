...
<script language="JavaScript">
    ...
    function onPageLoad()
    {
        ...
        set_checked("<% CmoGetCfg("ipv6_pppoe_connect_mode","none"); %>", get_by_name("ipv6_pppoe_connect_mode"));
        ...
        set_checked("<% CmoGetCfg("ipv6_dhcp_pd_enable_l","none"); %>", get_by_id("ipv6_dhcp_pd_lan"));
        ...
        get_by_id("ipv6_pppoe_password_v").value = get_by_id("ipv6_pppoe_password_s").value;
  ...
  function disable_autoconfig(){
    ...
    function clone_ipv4_pppoe(){
		...
		var ipv6_pppoe_share = get_by_name("ipv6_pppoe_share");
  		var wan_pppoe_username = htmlDecode("<% CmoGetCfg("wan_pppoe_username_00","none"); %>");
		var ipv6_pppoe_username = htmlDecode("<% CmoGetCfg("ipv6_pppoe_username","none"); %>");
		var wan_pppoe_service_00 = htmlDecode("<% CmoGetCfg("wan_pppoe_service_00","none"); %>");
		var ipv6_pppoe_service = htmlDecode("<% CmoGetCfg("ipv6_pppoe_service","none"); %>");

		//alert("wan_pppoe_username=" + wan_pppoe_username );
		//alert("ipv6_pppoe_username=" + ipv6_pppoe_username );
		if(ipv6_pppoe_share[0].checked){
			get_by_id("ipv6_pppoe_username").value = wan_pppoe_username;
			...
			get_by_id("ipv6_pppoe_service").value = wan_pppoe_service_00;
			set_checked("<% CmoGetCfg("wan_pppoe_connect_mode_00","none"); %>", get_by_name("ipv6_pppoe_connect_mode"));
			get_by_id("ipv6_pppoe_mtu").value = "<% CmoGetCfg("wan_pppoe_mtu","none"); %>";
			get_by_id("ipv6_pppoe_idle_time").value = "<% CmoGetCfg("wan_pppoe_max_idle_time_00","none"); %>";
			...
			get_by_id("ipv6_pppoe_username").value = ipv6_pppoe_username;
			get_by_id("ipv6_pppoe_password_s").value = "<% CmoGetCfg("ipv6_pppoe_password","none"); %>";
			get_by_id("ipv6_pppoe_password_v").value = "<% CmoGetCfg("ipv6_pppoe_password","none"); %>";
			get_by_id("ipv6_pppoe_service").value = ipv6_pppoe_service;
			set_checked("<% CmoGetCfg("ipv6_pppoe_connect_mode","none"); %>", get_by_name("ipv6_pppoe_connect_mode"));
			get_by_id("ipv6_pppoe_mtu").value ="<% CmoGetCfg("ipv6_pppoe_mtu","none"); %>";
			get_by_id("ipv6_pppoe_idle_time").value = "<% CmoGetCfg("ipv6_pppoe_idle_time","none"); %>";

			pppoe_connect_mode[0].disabled = false;
			pppoe_connect_mode[1].disabled = false;
    ...
    function disable_ipv6_poe_ip(){
        var fixIP = get_by_name("ipv6_pppoe_dynamic");
	  	get_by_id("ipv6_pppoe_ipaddr").disabled = fixIP[0].checked;
    }
    ...
    function disable_ipv6_pppoe_auto_dns(){
        ...
        get_by_id("ipv6_pppoe_primary_dns").disabled = fixIP[0].checked;
        get_by_id("ipv6_pppoe_secondary_dns").disabled = fixIP[0].checked;
    }
...
function send_request(){
    ...
    var pppoe_ip_msg = replace_msg(all_ip_addr_msg,"Local IPv6 address");
	...
	var mtu_obj = new varible_obj(get_by_id("ipv6_pppoe_mtu").value, mtu_msg , 1300, 1492, false);  
	...
	var adver_lifetime_obj = new varible_obj(get_by_id("ipv6_pppoe_adver_lifetime").value, adver_lifetime_msg , 1, 999999, false);
    ...
    if (get_by_id("ipv6_pppoe_username").value == "") {
          ...
          <div id=box_header>
             ...
             <script>show_words(IPV6_TEXT28)</script><br>
                    <br>
                        ...
                        <input name="button2" id="button2" type="button" class=button_submit value="" onclick="return page_cancel_1('form1', 'adv_ipv6_pppoe.asp');">
...
<option value="link_local"><script>show_words(IPV6_TEXT37a)</script></option>
                ...
                <div class=box id=wan_ipv6_pppoe_settings>
                    ...
                    <table cellSpacing=1 cellPadding=1 width=525 border=0>
                        ...
                        <tr>
                          ...
                          <td>&nbsp;
                            <input type=text id="ipv6_pppoe_ipaddr" name="ipv6_pppoe_ipaddr" size="40" maxlength="39" value="<% CmoGetCfg("ipv6_pppoe_ipaddr","none"); %>">
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>&nbsp;
                              <input type=radio name="ipv6_pppoe_connect_mode" value="always_on" onClick="check_ipv6_pppoe_connectmode()">
								<script>show_words(bwn_RM_0)</script>
                              <input type=radio name="ipv6_pppoe_connect_mode" value="on_demand" onClick="check_ipv6_pppoe_connectmode()" checked>
                        ...
                        <tr>
                          ...
                          <td>&nbsp;
                            <input type=text id="ipv6_pppoe_idle_time" name="ipv6_pppoe_idle_time" size="10" maxlength="5" value="<% CmoGetCfg("ipv6_pppoe_idle_time","none"); %>">
                        ...
                        <tr>
                          ...
                          <td>&nbsp;
                            <input type=text id="ipv6_pppoe_mtu" name="ipv6_pppoe_mtu" size="10" maxlength="5" value="<% CmoGetCfg("ipv6_pppoe_mtu","none"); %>">
															<script>show_words(bwn_bytes);</script> = 1492 </td>
                          </td>
                        </tr>
                    </table>
            </div>
         ...
         <div class=box id=lan_ipv6_settings>
                    ...
                    <table cellSpacing=1 cellPadding=1 width=525 border=0>
                      ...
                      <tr>
                          ...
                          <td width="331">&nbsp;
                            <input type=text id="ipv6_pppoe_lan_ip" name="ipv6_pppoe_lan_ip" size="30" maxlength="63" value="<% CmoGetCfg("ipv6_pppoe_lan_ip","none"); %>" onChange="set_ipv6_autoconf_range()">
                            <b>/64</b>
                          </td>
                      </tr>
                <tr>
         ...
         <div class="box" id=ipv6_autoconfiguration_settings>
			  <h2><script>show_words(IPV6_TEXT48);</script></h2>
			   <p class="style1"><script>show_words(IPV6_TEXT49);show_words(IPV6_TEXT49a);</script></p>
                ...
                <tr id="show_router_advert_lifetime">
                     ...
                     <td width="331">&nbsp;&nbsp;<input type=text id="ipv6_pppoe_adver_lifetime" name="ipv6_pppoe_adver_lifetime" size="20" maxlength="6" value="">
				     <script>show_words(_minutes)</script></td>
                </tr>
                          </table>
         </div>
