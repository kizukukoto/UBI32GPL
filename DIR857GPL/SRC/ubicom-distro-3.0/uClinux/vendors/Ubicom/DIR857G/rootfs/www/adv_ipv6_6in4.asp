	...
	function onPageLoad(){
		...
		link_local = get_by_id("link_local_ip_l").value;
	  	get_by_id("lan_link_local_ip").innerHTML= link_local.toUpperCase();
                ipv4_wan_ip = get_by_id("wan_current_ipaddr").value.split("/")[0];;
	  	get_by_id("ipv4_6in4_wan_ip").innerHTML= ipv4_wan_ip.toUpperCase();
...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
    ...
    <table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
        <tr>
		    ...
		    <input type="hidden" maxLength=80 size=80 name="wan_current_ipaddr" id="wan_current_ipaddr" value="<% CmoGetStatus("wan_current_ipaddr_00"); %>";>
          ...
          <div id=box_header>
                    ...
                    <br>
                        ...
                        <input name="button2" id="button2" type="button" class=button_submit value="" onclick="return page_cancel_1('form1', 'adv_ipv6_6in4.asp');">
