...
<script language="JavaScript">
    ...
    function xmldoc()
    {
        ...
        if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
        	...
        	temp_table = get_by_id("station_table_1");
            temp_sta_num = xmlhttp.responseXML.getElementsByTagName("num_5")[0].firstChild.nodeValue;

            if (temp_sta_num > 0) {  //5G
                for (var i = 0; i < temp_sta_num; i++) {
                    lenRow = parseInt(temp_table.rows.length);
                    temp_lenRow = parseInt(lenRow) -1;
                    if (temp_lenRow < temp_sta_num) {
                    ...
                    mac_address = xmlhttp.responseXML.getElementsByTagName("mac_5")[i].firstChild.nodeValue;
                    ip_address = xmlhttp.responseXML.getElementsByTagName("ip_5")[i].firstChild.nodeValue;
                    temp_type = xmlhttp.responseXML.getElementsByTagName("type_5")[i].firstChild.nodeValue;
                    temp_rate = xmlhttp.responseXML.getElementsByTagName("rate_5")[i].firstChild.nodeValue;
                    temp_rsi = xmlhttp.responseXML.getElementsByTagName("rsi_5")[i].firstChild.nodeValue;
            ...
            get_by_id("show_resert_1").innerHTML = temp_sta_num;
        ...
        <tr>
            ...
            <td valign="top" id="maincontent_container">
                <div id="maincontent">
                    ...
                    <div class="box">
                        <h2><script>show_words(sw_title_list)</script> - <script>show_words(GW_WLAN_RADIO_1_NAME)</script>:&nbsp;<span id="show_resert_1"></span></h2>
