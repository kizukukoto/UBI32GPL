  ...
  <tr>
    <td>
      <table width="838" border=0 align="center" cellPadding=0 cellSpacing=0 >
           ...
           <table width="650" border="0" align="center">
            <tr>
              <td height="15"><div id=box_header>
                  <h1><script>show_words(_uploadgood)</script>
                        </h1>
                  <p><script>show_words(_upgintro)</script>
                  </p>
                  <br>
              </div></td>
            </tr>
           ...
           <table width="650" border="0" align="center">
            <tr>
              <td height="15"><div id=box_header>
                  ...
                  <p>
                  <input type="button" class="button_submit" value="" id="Continue" name="Continue" onclick="back();">
                  <script>get_by_id("Continue").value = ub_continue;</script>
                  </p>
                  <br>
              </div></td>
            </tr>
        ...
        <!-- wrong language pack file -->
        <tr id="lp_fail_1" style="display:none">
          <td bgcolor="#FFFFFF"><p>&nbsp;</p>
           <table width="650" border="0" align="center">
            <tr>
              <td height="15"><div id=box_header>
                  <h1><script>show_words(ub_Upload_Failed)</script></h1>
                  <p align="center">
                  The language pack verify is failure.
                  </p>
                  <p align="center">
                  	<input type="button" class="button_submit" value="" id="Continue2" name="Continue2" onclick="back();">
                    <script>get_by_id("Continue2").value = ub_continue;</script>
                  </p>
                  <br>
              </div></td>
            </tr>
