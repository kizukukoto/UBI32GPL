...
ifeq ($(CONFIG_BOARD_IP7160DIR657BoardI),y)
CFLAGS := -march=ubicom32v4 -DIP7000 -DUBICOM32_ARCH_VERSION=4 -DHAVE_AV_CONFIG_H -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE \
          -I$(BUILD_ROOT_REL) -I$(SRC_PATH) $(OPTFLAGS) -Os
endif
