...
# if defined(FPM_IP7K) && !defined(OPT_SSO)
#  define OPT_SSO
# endif
		...
		unsigned int nch, unsigned int ns)
{
  ...
  for (ch = 0; ch < nch; ++ch) {
...
#else
      asm volatile (
	      " move.4 d15,   0(%[star_fx])         \n\t" /* d15 = (*fx)[0] */
	      " muls.4 acc1,  0(%[ptr]),      d15   \n\t" /* acc1 = (*fx)[0]*ptr[0] */
	      " move.4 %[lo], acc1_lo               \n\t" /* lo = (INT32)acc1 */
	      " move.4 d15,   4(%[star_fx])         \n\t" /* d15 = (*fx)[1] */
	      " muls.4 acc1,  56(%[ptr]),     d15   \n\t" /* acc1 = (*fx)[1]*ptr[14] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   8(%[star_fx])         \n\t" /* d15 = (*fx)[2] */
	      " muls.4 acc1,  48(%[ptr]),     d15   \n\t" /* acc1 = (*fx)[2]*ptr[12] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   12(%[star_fx])        \n\t" /* d15 = (*fx)[3] */
	      " muls.4 acc1,  40(%[ptr]),     d15   \n\t" /* acc1 = (*fx)[3]*ptr[10] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   16(%[star_fx])        \n\t" /* d15 = (*fx)[4] */
	      " muls.4 acc1,  32(%[ptr]),     d15   \n\t" /* acc1 = (*fx)[4]*ptr[8] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   20(%[star_fx])        \n\t" /* d15 = (*fx)[5] */
	      " muls.4 acc1,  24(%[ptr]),     d15   \n\t" /* acc1 = (*fx)[5]*ptr[6] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   24(%[star_fx])        \n\t" /* d15 = (*fx)[6] */
	      " muls.4 acc1,  16(%[ptr]),     d15   \n\t" /* acc1 = (*fx)[6]*ptr[4] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   28(%[star_fx])        \n\t" /* d15 = (*fx)[7] */
	      " muls.4 acc1,  8(%[ptr]),      d15   \n\t" /* acc1 = (*fx)[7]*ptr[2] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      : [lo] "=&d" (lo)
	      : [star_fx] "a" (*fx), [ptr] "a" (ptr)
	      : "d15", "acc1_hi", "acc1_lo", "cc"
      );
...
#else
      asm volatile (
	      " move.4 d15,   0(%[star_fe])       \n\t" /* d15 = (*fe)[0] */
	      " muls.4 acc1,  0(%[ptr]),    d15   \n\t" /* acc1 = (*fe)[0]*ptr[0] */
	      " add.4  %[lo], acc1_lo,      %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   4(%[star_fe])       \n\t" /* d15 = (*fe)[1] */
	      " muls.4 acc1,  56(%[ptr]),   d15   \n\t" /* acc1 = (*fe)[1]*ptr[14] */
	      " add.4  %[lo], acc1_lo,      %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   8(%[star_fe])       \n\t" /* d15 = (*fe)[2] */
	      " muls.4 acc1,  48(%[ptr]),   d15   \n\t" /* acc1 = (*fe)[2]*ptr[12] */
	      " add.4  %[lo], acc1_lo,      %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   12(%[star_fe])      \n\t" /* d15 = (*fe)[3] */
	      " muls.4 acc1,  40(%[ptr]),   d15   \n\t" /* acc1 = (*fe)[3]*ptr[10] */
	      " add.4  %[lo], acc1_lo,      %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   16(%[star_fe])      \n\t" /* d15 = (*fe)[4] */
	      " muls.4 acc1,  32(%[ptr]),   d15   \n\t" /* acc1 = (*fe)[4]*ptr[8] */
	      " add.4  %[lo], acc1_lo,      %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   20(%[star_fe])      \n\t" /* d15 = (*fe)[5] */
	      " muls.4 acc1,  24(%[ptr]),   d15   \n\t" /* acc1 = (*fe)[5]*ptr[6] */
	      " add.4  %[lo], acc1_lo,      %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   24(%[star_fe])      \n\t" /* d15 = (*fe)[6] */
	      " muls.4 acc1,  16(%[ptr]),   d15   \n\t" /* acc1 = (*fe)[6]*ptr[4] */
	      " add.4  %[lo], acc1_lo,      %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   28(%[star_fe])      \n\t" /* d15 = (*fe)[7] */
	      " muls.4 acc1,  8(%[ptr]),    d15   \n\t" /* acc1 = (*fe)[7]*ptr[2] */
	      " add.4  %[lo], acc1_lo,      %[lo] \n\t" /* lo += (INT32)acc1 */
	      : [lo] "+d" (lo)
	      : [star_fe] "a" (*fe), [ptr] "a" (ptr)
	      : "d15", "acc1_hi", "acc1_lo", "cc"
      );
#endif
	...
	*pcm2-- = SHIFT(MLZ(hi, lo));
...
#if 0 // Test reordering code in C (=1) or inline asm (=0)
	register mad_fixed64lo_t lo2;
	...
	ptr = *Dptr - po;
	ML0(hi, lo2, (*fo)[7], ptr[31 -  2]);
	MLA(hi, lo2, (*fo)[6], ptr[31 -  4]);
	MLA(hi, lo2, (*fo)[5], ptr[31 -  6]);
	MLA(hi, lo2, (*fo)[4], ptr[31 -  8]);
	MLA(hi, lo2, (*fo)[3], ptr[31 - 10]);
	MLA(hi, lo2, (*fo)[2], ptr[31 - 12]);
	MLA(hi, lo2, (*fo)[1], ptr[31 - 14]);
	MLA(hi, lo2, (*fo)[0], ptr[31 - 16]);

	ptr = *Dptr - pe;
	MLA(hi, lo2, (*fe)[0], ptr[31 - 16]);
	MLA(hi, lo2, (*fe)[1], ptr[31 - 14]);
	MLA(hi, lo2, (*fe)[2], ptr[31 - 12]);
	MLA(hi, lo2, (*fe)[3], ptr[31 - 10]);
	MLA(hi, lo2, (*fe)[4], ptr[31 -  8]);
	MLA(hi, lo2, (*fe)[5], ptr[31 -  6]);
	MLA(hi, lo2, (*fe)[6], ptr[31 -  4]);
	MLA(hi, lo2, (*fe)[7], ptr[31 -  2]);
	...
	*pcm2-- = SHIFT(MLZ(hi, lo2));
	...
	mad_fixed_t star_fo0 = (*fo)[0];
	mad_fixed_t star_fo1 = (*fo)[1];
	mad_fixed_t star_fo2 = (*fo)[2];
	mad_fixed_t star_fo3 = (*fo)[3];
	mad_fixed_t star_fo4 = (*fo)[4];
	mad_fixed_t star_fo5 = (*fo)[5];
	mad_fixed_t star_fo6 = (*fo)[6];
	mad_fixed_t star_fo7 = (*fo)[7];

	ptr = *Dptr + po;
	asm volatile (
		" muls.4 acc1,  0(%[ptr]),  %[star_fo0] \n\t" /* acc1 = (*fo)[0]*ptr[0] */
		" move.4 %[lo], acc1_lo                 \n\t" /* lo = (INT32)acc1 */
		" muls.4 acc1,  56(%[ptr]), %[star_fo1] \n\t" /* acc1 = (*fo)[1]*ptr[14] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  48(%[ptr]), %[star_fo2] \n\t" /* acc1 = (*fo)[2]*ptr[12] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  40(%[ptr]), %[star_fo3] \n\t" /* acc1 = (*fo)[3]*ptr[10] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  32(%[ptr]), %[star_fo4] \n\t" /* acc1 = (*fo)[4]*ptr[8] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  24(%[ptr]), %[star_fo5] \n\t" /* acc1 = (*fo)[5]*ptr[6] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  16(%[ptr]), %[star_fo6] \n\t" /* acc1 = (*fo)[6]*ptr[4] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  8(%[ptr]),  %[star_fo7] \n\t" /* acc1 = (*fo)[7]*ptr[2] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		: [lo] "=&d" (lo)
		: [ptr] "a" (ptr), [star_fo0] "d" (star_fo0), [star_fo1] "d" (star_fo1), [star_fo2] "d" (star_fo2), [star_fo3] "d" (star_fo3), [star_fo4] "d" (star_fo4), [star_fo5] "d" (star_fo5), [star_fo6] "d" (star_fo6), [star_fo7] "d" (star_fo7)
		: "acc1_hi", "acc1_lo", "cc"
	);
	lo = -lo;
	...
	ptr = *Dptr - po;
	asm volatile (
		" muls.4 acc1,   116(%[ptr]),   %[star_fo7] \n\t" /* acc1 = (*fo)[7]*ptr[29] */
		" move.4 %[lo2], acc1_lo                    \n\t" /* lo2 += (INT32)acc1 */
		" muls.4 acc1,   108(%[ptr]),   %[star_fo6] \n\t" /* acc1 = (*fo)[6]*ptr[27] */
		" add.4  %[lo2], acc1_lo,       %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		" muls.4 acc1,   100(%[ptr]),   %[star_fo5] \n\t" /* acc1 = (*fo)[5]*ptr[25] */
		" add.4  %[lo2], acc1_lo,       %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		" muls.4 acc1,   92(%[ptr]),    %[star_fo4] \n\t" /* acc1 = (*fo)[4]*ptr[23] */
		" add.4  %[lo2], acc1_lo,       %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		" muls.4 acc1,   84(%[ptr]),    %[star_fo3] \n\t" /* acc1 = (*fo)[3]*ptr[21] */
		" add.4  %[lo2], acc1_lo,       %[lo2]      \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,   76(%[ptr]),    %[star_fo2] \n\t" /* ac2c1 = (*fo)[2]*ptr[19] */
		" add.4  %[lo2], acc1_lo,       %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		" muls.4 acc1,   68(%[ptr]),    %[star_fo1] \n\t" /* acc1 = (*fo)[1]*ptr[17] */
		" add.4  %[lo2], acc1_lo,       %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		" muls.4 acc1,   60(%[ptr]),    %[star_fo0] \n\t" /* acc1 = (*fo)[0]*ptr[15] */
		" add.4  %[lo2], acc1_lo,       %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		: [lo2] "=&d" (lo2)
		: [ptr] "a" (ptr), [star_fo7] "d" (star_fo7), [star_fo6] "d" (star_fo6), [star_fo5] "d" (star_fo5), [star_fo4] "d" (star_fo4), [star_fo3] "d" (star_fo3), [star_fo2] "d" (star_fo2), [star_fo1] "d" (star_fo1), [star_fo0] "d" (star_fo0)
		: "acc1_hi", "acc1_lo", "cc"
	);

	mad_fixed_t star_fe0 = (*fe)[0];
	mad_fixed_t star_fe1 = (*fe)[1];
	mad_fixed_t star_fe2 = (*fe)[2];
	mad_fixed_t star_fe3 = (*fe)[3];
	mad_fixed_t star_fe4 = (*fe)[4];
	mad_fixed_t star_fe5 = (*fe)[5];
	mad_fixed_t star_fe6 = (*fe)[6];
	mad_fixed_t star_fe7 = (*fe)[7];

	ptr = *Dptr - pe;
	asm volatile (
		" muls.4 acc1,   60(%[ptr]),  %[star_fe0] \n\t" /* acc1 = (*fe)[0]*ptr[15] */
		" add.4  %[lo2], acc1_lo,     %[lo2]      \n\t" /* lo2 = (INT32)acc1 */
		" muls.4 acc1,   68(%[ptr]),  %[star_fe1] \n\t" /* acc1 = (*fe)[1]*ptr[17] */
		" add.4  %[lo2], acc1_lo,     %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		" muls.4 acc1,   76(%[ptr]),  %[star_fe2] \n\t" /* acc1 = (*fe)[2]*ptr[19] */
		" add.4  %[lo2], acc1_lo,     %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		" muls.4 acc1,   84(%[ptr]),  %[star_fe3] \n\t" /* acc1 = (*fe)[3]*ptr[21] */
		" add.4  %[lo2], acc1_lo,     %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		" muls.4 acc1,   92(%[ptr]),  %[star_fe4] \n\t" /* acc1 = (*fe)[4]*ptr[23] */
		" add.4  %[lo2], acc1_lo,     %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		" muls.4 acc1,   100(%[ptr]), %[star_fe5] \n\t" /* acc1 = (*fe)[5]*ptr[25] */
		" add.4  %[lo2], acc1_lo,     %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		" muls.4 acc1,   108(%[ptr]), %[star_fe6] \n\t" /* acc1 = (*fe)[6]*ptr[27] */
		" add.4  %[lo2], acc1_lo,     %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		" muls.4 acc1,   116(%[ptr]), %[star_fe7] \n\t" /* acc1 = (*fe)[7]*ptr[29] */
		" add.4  %[lo2], acc1_lo,     %[lo2]      \n\t" /* lo2 += (INT32)acc1 */
		: [lo2] "+d" (lo2)
		: [ptr] "a" (ptr), [star_fe0] "d" (star_fe0), [star_fe1] "d" (star_fe1), [star_fe2] "d" (star_fe2), [star_fe3] "d" (star_fe3), [star_fe4] "d" (star_fe4), [star_fe5] "d" (star_fe5), [star_fe6] "d" (star_fe6), [star_fe7] "d" (star_fe7)
		: "acc1_hi", "acc1_lo", "cc"
	);

	ptr = *Dptr + pe;
	asm volatile (
		" muls.4 acc1,  8(%[ptr]),  %[star_fe7] \n\t" /* acc1 = (*fe)[7]*ptr[2] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  16(%[ptr]), %[star_fe6] \n\t" /* acc1 = (*fe)[6]*ptr[4] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  24(%[ptr]), %[star_fe5] \n\t" /* acc1 = (*fe)[5]*ptr[6] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  32(%[ptr]), %[star_fe4] \n\t" /* acc1 = (*fe)[4]*ptr[8] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  40(%[ptr]), %[star_fe3] \n\t" /* acc1 = (*fe)[3]*ptr[10] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  48(%[ptr]), %[star_fe2] \n\t" /* acc1 = (*fe)[2]*ptr[12] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  56(%[ptr]), %[star_fe1] \n\t" /* acc1 = (*fe)[1]*ptr[14] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		" muls.4 acc1,  0(%[ptr]),  %[star_fe0] \n\t" /* acc1 = (*fe)[0]*ptr[0] */
		" add.4  %[lo], acc1_lo,    %[lo]       \n\t" /* lo += (INT32)acc1 */
		: [lo] "+d" (lo)
		: [ptr] "a" (ptr), [star_fe7] "d" (star_fe7), [star_fe6] "d" (star_fe6), [star_fe5] "d" (star_fe5), [star_fe4] "d" (star_fe4), [star_fe3] "d" (star_fe3), [star_fe2] "d" (star_fe2), [star_fe1] "d" (star_fe1), [star_fe0] "d" (star_fe0)
		: "acc1_hi", "acc1_lo", "cc"
	);
...
#else
      asm volatile (
	      " move.4 d15,   0(%[star_fo])         \n\t" /* d15 = (*fo)[0] */
	      " muls.4 acc1,  0(%[ptr]),      d15   \n\t" /* acc1 = (*fo)[0]*ptr[0] */
	      " move.4 %[lo], acc1_lo               \n\t" /* lo = (INT32)acc1 */
	      " move.4 d15,   4(%[star_fo])         \n\t" /* d15 = (*fo)[1] */
	      " muls.4 acc1,  56(%[ptr]),     d15   \n\t" /* acc1 = (*fo)[1]*ptr[14] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   8(%[star_fo])         \n\t" /* d15 = (*fo)[2] */
	      " muls.4 acc1,  48(%[ptr]),     d15   \n\t" /* acc1 = (*fo)[2]*ptr[12] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   12(%[star_fo])        \n\t" /* d15 = (*fo)[3] */
	      " muls.4 acc1,  40(%[ptr]),     d15   \n\t" /* acc1 = (*fo)[3]*ptr[10] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   16(%[star_fo])        \n\t" /* d15 = (*fo)[4] */
	      " muls.4 acc1,  32(%[ptr]),     d15   \n\t" /* acc1 = (*fo)[4]*ptr[8] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   20(%[star_fo])        \n\t" /* d15 = (*fo)[5] */
	      " muls.4 acc1,  24(%[ptr]),     d15   \n\t" /* acc1 = (*fo)[5]*ptr[6] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   24(%[star_fo])        \n\t" /* d15 = (*fo)[6] */
	      " muls.4 acc1,  16(%[ptr]),     d15   \n\t" /* acc1 = (*fo)[6]*ptr[4] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      " move.4 d15,   28(%[star_fo])        \n\t" /* d15 = (*fo)[7] */
	      " muls.4 acc1,  8(%[ptr]),      d15   \n\t" /* acc1 = (*fo)[7]*ptr[2] */
	      " add.4  %[lo], acc1_lo,        %[lo] \n\t" /* lo += (INT32)acc1 */
	      : [lo] "=&d" (lo)
	      : [star_fo] "a" (*fo), [ptr] "a" (ptr)
	      : "d15", "acc1_hi", "acc1_lo", "cc"
      );
#endif
      *pcm1 = SHIFT(-MLZ(hi, lo));
