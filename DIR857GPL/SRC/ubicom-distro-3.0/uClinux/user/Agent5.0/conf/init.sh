...
#################################################
#Create the Device
sqlite3 tr.db "INSERT INTO tr(pid, name, rw, type) VALUES (-1, 'InternetGatewayDevice', 'false', 'node');"
...
sqlite3 tr.db "INSERT INTO tr(pid, name, rw, noc, nocc, acl, type, value) VALUES ($server, 'URL', 'true', 0, '', '', 'string', ' http://116.213.94.142/comserver/node1/tr069');"
