...
/* $Id: iscprint.c,v 1.1 2008/01/25 10:36:55 chase Exp $ */
...
"$Id: iscprint.c,v 1.1 2008/01/25 10:36:55 chase Exp $ Copyright (c) 2004 Internet Systems Consortium, Inc.  All rights reserved.";
#endif
