...
#define WEB_COPYRIGHT "Copyright &copy; 2004-2013 D-Link Corporation, Inc."
...
extern void return_ipv6_get_ula(webs_t wp,char *args);
extern void return_default_ula(webs_t wp,char *args);
#ifdef IPV6_DSLITE
...
extern void return_ipv6_get_ntp_list(webs_t wp,char *args);
extern void return_ipv6_wan_connect_time(webs_t wp,char *args);
#endif
