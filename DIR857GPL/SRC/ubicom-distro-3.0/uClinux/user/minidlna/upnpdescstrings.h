...
/* strings used in the root device xml description */
 ...
 #endif
#else
#define ROOTDEV_MANUFACTURERURL		"http://www.dlink.com/"
#define ROOTDEV_MANUFACTURER		"D-Link"
#define ROOTDEV_MODELNAME			"Windows Media Connect compatible (D-Link Router)"
#define ROOTDEV_MODELURL			OS_URL
#define ROOTDEV_MODELDESCRIPTION	"D-Link Broadband Router"
