...
#ident  "ACI $Id: //depot/sw/src/dk/mdk/common/include/common_hwext.h#10 $, $Header: //depot/sw/src/dk/mdk/common/include/common_hwext.h#10 $"
...
A_UINT8  hwMemRead8 (A_UINT16 devIndex, A_UINT_PTR memAddress);
A_UINT16 hwMemRead16(A_UINT16 devIndex, A_UINT_PTR memAddress);
A_UINT32 hwMemRead32(A_UINT16 devIndex, A_UINT_PTR memAddress);

void hwMemWrite8(A_UINT16 devIndex, A_UINT_PTR memAddress, A_UINT8 writeValue);
void hwMemWrite16(A_UINT16 devIndex, A_UINT_PTR memAddress, A_UINT16 writeValue);
void hwMemWrite32(A_UINT16 devIndex, A_UINT_PTR memAddress, A_UINT32 writeValue);
