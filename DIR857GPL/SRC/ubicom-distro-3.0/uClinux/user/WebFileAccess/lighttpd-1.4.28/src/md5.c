...
/* MD5 block update operation. Continues an MD5 message-digest
  ...
  context.
 */
void builtin_MD5_Update (context, _input, inputLen)
MD5_CTX *context;                                        /* context */
 ...
 */
void builtin_MD5_Final (digest, context)
...
*/
  ...
  builtin_MD5_Update (context, PADDING, padLen);

  /* Append length (before padding) */
  builtin_MD5_Update (context, bits, 8);
