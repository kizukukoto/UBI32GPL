 ...
 */
#define RADIUS_CLIENT_FIRST_WAIT 2 /* 2011/7/11, Robert change first retry timeout from 3 to 2. */

/**
 * RADIUS_CLIENT_MAX_WAIT - RADIUS client maximum retry timeout in seconds
 */
#define RADIUS_CLIENT_MAX_WAIT 3 /* 2011/7/11, Robert change maximum retry timeout from 120 to 3*/
 ...
 */
#define RADIUS_CLIENT_NUM_FAILOVER 2 /* 2011/7/11, Robert change retry times from 4 to 2*/
...
/*
name: Charles Teng
reason: add retry counter to handle send error. and then radius client will do failover.
	
*/	    	
static int i_retry = 3;
