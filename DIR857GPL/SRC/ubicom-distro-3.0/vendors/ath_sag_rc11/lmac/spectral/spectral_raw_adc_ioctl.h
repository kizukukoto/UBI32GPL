...
typedef struct {
    int16_t sampleI;    /* data is always little-endian, signed, 10 bit for Osprey, 9 bit for Merlin */
    int16_t sampleQ;    /* data is always little-endian, signed, 10 bit for Osprey, 9 bit for Merlin */
} SPECTRAL_ADC_SAMPLE;
