 ...
 * 2011.05.10
 */
    u_int32_t							mgl_group_ipv4;
    u_int32_t							mgl_group_saddr;

/*
 * 2011.06.21
 */
    unsigned char						mgl_group_ipv6[16];
    unsigned char						mgl_group_ipv6_saddr[16];
    long							ipv4;
...
#ifdef SUPPORT_IGMP_FSFILE
	struct igmp_fs_private *priv_ipv4;
	struct igmp_fs_private *priv_ipv6;
#endif
};
