...
ieee80211_check_seq_counter(wlan_p2p_t p2p_handle, struct ieee80211_frame *wh)
{
    ...
    if (ctr == NULL) {
        ...
        IEEE80211_ADDR_COPY(ctr->src, src_addr);
                               ...
                               u_int32_t data_len)
{
    ...
    if (act_frame) {
        ...
        IEEE80211_ADDR_COPY(act_frame->dst, dst_addr);
        IEEE80211_ADDR_COPY(act_frame->src, src_addr);
        IEEE80211_ADDR_COPY(act_frame->bssid, bssid);
