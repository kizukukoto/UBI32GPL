...
void phy_mode_setup(void)
{
    ...
    phy_reg_write(ATHR_PHYBASE(ATHR_IND_PHY), ATHR_PHYADDR(ATHR_IND_PHY), 29, 11);     
    phy_reg_write(ATHR_PHYBASE(ATHR_IND_PHY), ATHR_PHYADDR(ATHR_IND_PHY), 30, 0xbc40);   
#endif
}
...
/* Eanble IGMP snooping (to CPU port - port 0) and allow VLAN tag */
		athrs17_reg_write(0x210,
			athrs17_reg_read(0x210) | (6 << 8) | (6 << 16) | (6 << 24));
		athrs17_reg_write(0x214,
			athrs17_reg_read(0x214) | (6 << 0) | (6 << 8));
	...
	athrs17_reg_write(0x0618, athrs17_reg_read(0x0618) | (1 << 28));
	...
	#if 1 //Ubicom fix : multicast issue
  /* Eanble IGMP snooping (to CPU port - port 0) and allow VLAN tag */
	athrs17_reg_write(0x210, athrs17_reg_read(0x210) | (6 << 0) | (6 << 8) | (6 << 16) | (6 << 24));
	athrs17_reg_write(0x214, athrs17_reg_read(0x214) | (6 << 0) | (1 << 24));
  #endif
...
//Print all register value
...
#if 1
		/* ACL to forward SSDP within CPU and LAN */
		athrs17_reg_write(0x0030, athrs17_reg_read(0x0030) | (1 << 1));
		
    athrs17_reg_write(0x404, 0xeffffffa);
    athrs17_reg_write(0x408, 0x00000000);
    athrs17_reg_write(0x40c, 0x00000000);
    athrs17_reg_write(0x410, 0x00000000);
    athrs17_reg_write(0x414, 0x0000001f);
    athrs17_reg_write(0x400, 0x80000000);

    athrs17_reg_write(0x404, 0xffffffff);
    athrs17_reg_write(0x408, 0x00000000);
    athrs17_reg_write(0x40c, 0x00000000);
    athrs17_reg_write(0x410, 0x00030000);
    athrs17_reg_write(0x414, 0x000000c2);
    athrs17_reg_write(0x400, 0x80000100);

    athrs17_reg_write(0x404, 0x00000000);
    athrs17_reg_write(0x408, 0xe0000000);
    athrs17_reg_write(0x40c, 0x00000013);
    athrs17_reg_write(0x410, 0x00000000);
    athrs17_reg_write(0x414, 0x00000000);
    athrs17_reg_write(0x400, 0x80000200);
    
    /* Forward IPv6 multicast ff02::1:ffxx:xxxx */
    athrs17_reg_write(0x404, 0xff000000);
    athrs17_reg_write(0x408, 0x00000001);
    athrs17_reg_write(0x40c, 0x00000000);
    athrs17_reg_write(0x410, 0xff020000);
    athrs17_reg_write(0x414, 0x0000001f);
    athrs17_reg_write(0x400, 0x80000001);

    athrs17_reg_write(0x404, 0xff000000);
    athrs17_reg_write(0x408, 0xffffffff);
    athrs17_reg_write(0x40c, 0xffffffff);
    athrs17_reg_write(0x410, 0xffffffff);
    athrs17_reg_write(0x414, 0x000000c3);
    athrs17_reg_write(0x400, 0x80000101);
    ...
    athrs17_reg_write(0x410, 0x00000000);
    athrs17_reg_write(0x414, 0x00000000);
    athrs17_reg_write(0x400, 0x80000201);
    
    /* Forward IPv6 multicast ff02::2:xxxx:xxxx */
    athrs17_reg_write(0x404, 0x00000000);
    athrs17_reg_write(0x408, 0x00000002);
    athrs17_reg_write(0x40c, 0x00000000);
    athrs17_reg_write(0x410, 0xff020000);
    athrs17_reg_write(0x414, 0x0000001f);
    athrs17_reg_write(0x400, 0x80000002);
    ...
    athrs17_reg_write(0x410, 0xffffffff);
    athrs17_reg_write(0x414, 0x000000c3);
    athrs17_reg_write(0x400, 0x80000102);
    ...
    athrs17_reg_write(0x410, 0x00000000);
    athrs17_reg_write(0x414, 0x00000000);
    athrs17_reg_write(0x400, 0x80000202);
    
    /* Forward IPv6 multicast ff02::xx */
    athrs17_reg_write(0x404, 0x00000000);
    athrs17_reg_write(0x408, 0x00000000);
    athrs17_reg_write(0x40c, 0x00000000);
    athrs17_reg_write(0x410, 0xff020000);
    athrs17_reg_write(0x414, 0x0000001f);
    athrs17_reg_write(0x400, 0x80000003);

    athrs17_reg_write(0x404, 0xffffff00);
    athrs17_reg_write(0x408, 0xffffffff);
    athrs17_reg_write(0x40c, 0xffffffff);
    athrs17_reg_write(0x410, 0xffffffff);
    athrs17_reg_write(0x414, 0x000000c3);
    athrs17_reg_write(0x400, 0x80000103);
    ...
    athrs17_reg_write(0x410, 0x00000000);
    athrs17_reg_write(0x414, 0x00000000);
    athrs17_reg_write(0x400, 0x80000203);
    
    /* Forward IPv6 multicast ff02::1:x */
    athrs17_reg_write(0x404, 0x00010000);
    athrs17_reg_write(0x408, 0x00000000);
    athrs17_reg_write(0x40c, 0x00000000);
    athrs17_reg_write(0x410, 0xff020000);
    athrs17_reg_write(0x414, 0x0000001f);
    athrs17_reg_write(0x400, 0x80000004);

    athrs17_reg_write(0x404, 0xfffffffc);
    athrs17_reg_write(0x408, 0xffffffff);
    athrs17_reg_write(0x40c, 0xffffffff);
    athrs17_reg_write(0x410, 0xffffffff);
    athrs17_reg_write(0x414, 0x000000c3);
    athrs17_reg_write(0x400, 0x80000104);
    ...
    athrs17_reg_write(0x410, 0x00000000);
    athrs17_reg_write(0x414, 0x00000000);
    athrs17_reg_write(0x400, 0x80000204);
    ...
    /* Modify by Atheros Richard Huang */
    phy_reg_write(0, 0x4, 0x1d, 0x12);     
    phy_reg_write(0, 0x4, 0x1e, 0x4c0c);   
    phy_reg_write(0, 0x4, 0x1d, 0x0);     
    phy_reg_write(0, 0x4, 0x1e, 0x82ee);
    phy_reg_write(0, 0x4, 0x1d, 0x5);     
    phy_reg_write(0, 0x4, 0x1e, 0x3d46);
    phy_reg_write(0, 0x4, 0x1d, 0xb);     
    phy_reg_write(0, 0x4, 0x1e, 0xbc40);
