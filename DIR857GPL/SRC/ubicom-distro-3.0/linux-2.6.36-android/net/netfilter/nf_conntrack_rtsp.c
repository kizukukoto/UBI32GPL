...
*/
		...
		if (nf_nat_rtsp && ct->status & IPS_NAT_MASK)
			...
			ret = nf_nat_rtsp(skb, ctinfo, hdrsoff, hdrslen, &expinfo, rtp_exp, rtcp_exp);
		else if ((nf_ct_expect_related(rtp_exp) != 0) || (nf_ct_expect_related(rtcp_exp) != 0)) {
