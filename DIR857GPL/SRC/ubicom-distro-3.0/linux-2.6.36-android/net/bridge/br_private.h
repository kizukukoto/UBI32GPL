...
struct net_bridge_mdb_entry
{
	...
	struct timer_list		query_timer;
	struct br_ip			addr;
	bool				mglist; //John Huang add for Fix for crash caused by bridge multicast code
	u32				queries_sent;
};
...
#define BR_SET_MAC_ADDR		0x00000001
	...
	unsigned char			guestzone_enabled; //Bridge support guest zone settings
	u32						br_ip; //Bridge IP
#if 1
//	u32 reserced[2];
	u32						webfileaccess_port; //Bridge IP
	u32						webfileaccessssl_port; //Bridge IP
#endif	
#endif
};
