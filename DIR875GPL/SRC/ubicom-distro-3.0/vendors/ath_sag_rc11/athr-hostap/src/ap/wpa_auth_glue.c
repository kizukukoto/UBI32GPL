...
int hostapd_setup_wpa(struct hostapd_data *hapd)
{
	...
	wpa_printf(MSG_CAMEO, "CAMEO: hostapd_setup_wpa: hostapd_wpa_auth_conf");
...
#endif /* CONFIG_IEEE80211R */
	wpa_printf(MSG_CAMEO, "CAMEO: hostapd_setup_wpa: wpa_init");
	...
	wpa_printf(MSG_CAMEO, "CAMEO: hostapd_setup_wpa: hostapd_set_privacy");
	...
	wpa_printf(MSG_CAMEO, "CAMEO: hostapd_setup_wpa: wpa_auth_get_wpa_ie");
