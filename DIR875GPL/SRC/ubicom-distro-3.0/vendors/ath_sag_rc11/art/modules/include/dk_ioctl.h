...
#else
#define DK_IOCTL_GET_VERSION          _IO('A', 1)
#define DK_IOCTL_GET_CLIENT_INFO      _IO('A', 2)
#define DK_IOCTL_CFG_READ     _IO('A', 3)
#define DK_IOCTL_CFG_WRITE     _IO('A', 4)
#define DK_IOCTL_CREATE_EVENT     _IO('A', 5)
#define DK_IOCTL_GET_NEXT_EVENT     _IO('A', 6)
#define DK_IOCTL_SYS_REG_READ_32     _IO('A', 7)
#define DK_IOCTL_SYS_REG_WRITE_32     _IO('A', 8)
#define DK_IOCTL_FLASH_READ     _IO('A', 9)
#define DK_IOCTL_FLASH_WRITE     _IO('A', 10)
#define DK_IOCTL_MAC_WRITE     _IO('A', 11)
#define DK_IOCTL_GET_CHIP_ID     _IO('A', 12)
#define DK_IOCTL_RTC_REG_READ     _IO('A', 13)
#define DK_IOCTL_RTC_REG_WRITE      _IO('A', 14)
#define DK_IOCTL_FULL_ADDR_READ      _IO('A', 15)
#define DK_IOCTL_FULL_ADDR_WRITE      _IO('A', 16)
#endif
