...
static inline void OS_FLUSH_AR5416_TX_DESC(void *addr, int sync)
{
    asm volatile (
    " flush   (%[addr]) \n\t"
    " flush 32(%[addr]) \n\t"
...
static inline void OS_FLUSH_AR5416_RX_DESC(void *addr, int sync)
{
    asm volatile (
    " flush   (%[addr]) \n\t"
    " flush 32(%[addr]) \n\t"
...
#else
#define OS_FLUSH_AR5416_TX_DESC(addr, sync)
#define OS_FLUSH_AR5416_RX_DESC(addr, sync)
#endif
