...
#define IEEE80211_STATE_LOCK(_ic)                  spin_lock_bh(&(_ic)->ic_state_lock)
#define IEEE80211_STATE_UNLOCK(_ic)                spin_unlock_bh(&(_ic)->ic_state_lock)
...
#define IEEE80211_COMM_LOCK(_ic)                   spin_lock_bh(&(_ic)->ic_lock)
#define IEEE80211_COMM_UNLOCK(_ic)                 spin_unlock_bh(&(_ic)->ic_lock)
