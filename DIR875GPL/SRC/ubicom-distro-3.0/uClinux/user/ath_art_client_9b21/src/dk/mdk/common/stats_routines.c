...
if(pStatsInfo->status1 & 0x30004) {
    printf("Underrun bits fifo = %d, dlmtr = %d, data = %d\n",
        (pStatsInfo->status1 & 0x4),
        (pStatsInfo->status1 & 0x10000) >> 16,
        (pStatsInfo->status1 & 0x20000) >> 17);
          txStats[0].underruns ++;
