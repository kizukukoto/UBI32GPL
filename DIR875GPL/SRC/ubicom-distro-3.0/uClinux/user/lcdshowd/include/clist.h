...
#define LITE_LIST(l) ((CLiteList*)(l))

/* @brief LiteList structure */
typedef struct _CLiteList CLiteList;
 ...
 * @return void
*/
typedef void (*ListSelChangeFunc) (CLiteList *list,
                                   int       new_item,
                                   void     *ctx);
 ...
 * @return void
*/
typedef void (*ListDrawItemFunc) (CLiteList     *list,
 ...
 */
DFBResult lite_new_clist(LiteBox        *parent,
                        DFBRectangle   *rect,
                        LiteListTheme  *theme,
                        CLiteList      **ret_list);
 ...
 * @return DFBResult            Returns DFB_OK if successful
 */
DFBResult lite_clist_set_row_height(CLiteList *list,
                                    int      row_height);
 ...
 * @return DFBResult            Returns DFB_OK if successful
 */
DFBResult lite_clist_get_row_height(CLiteList *list,
                                   int      *row_height);
 ...
 * @return DFBResult            Returns DFB_OK if successful
 */
DFBResult lite_clist_insert_item(CLiteList        *list, 
                                int              index,
 ...
 * @return DFBResult            Returns DFB_OK if successful
 */
DFBResult lite_clist_get_item(CLiteList         *list,
                             int               index,
 ...
 * @return DFBResult            Returns DFB_OK if successful
 */
DFBResult lite_clist_set_item(CLiteList *list,
                             int index,
//                             LiteListItemData data);
                             char *data);
 ...
 * @return DFBResult            Returns DFB_OK if successful
 */
DFBResult lite_clist_sort_items(CLiteList *list,
 ...
 * @return DFBResult            Returns DFB_OK if successful.
 */
DFBResult lite_clist_on_draw_item(CLiteList    *list,
 ...
 * @return DFBResult            Returns DFB_OK if successful.     
 */
DFBResult lite_clist_on_sel_change(CLiteList     *list,
 ...
 * @return DFBResult            Returns DFB_OK if successful.
 */
DFBResult lite_new_clist_theme(const char     *scrollbar_image_path,
