...
#ident  "ACI $Id: //depot/sw/src/dk/mdk/devlib/ar6000/mEep6000.c#18 $, $Header: //depot/sw/src/dk/mdk/devlib/ar6000/mEep6000.c#18 $"
...
#define N(a)            (sizeof (a) / sizeof (a[0]))
    ...
    for (i = 0; i < N(ratesArray); i++) {
        ratesArray[i] = (A_UINT16) (ratesArray[i] + txPowerIndexOffset);
