...
# SDK directory
SDK_DIR = /home/twu/work/ubicom-distro-3.0/ultra
...
APP_BOOTLOADER_RESERVED_SPACE_IN_SECTORS = 2
...
# Kernel command line
APP_BOOTARGS = mtdparts=ubicom32fc.0:512k(bootloader)ro,13568k(rootfs),1536k(rootfs_data),256k(fw_env),256k(language_pack),256k(artblock)

# uClinux memory start address offset
APP_UCLINUX_MEM_START_ADDR = 0x00100000

# Board Name
AP_BOARD_NAME = IP8100_DIR857_BOARD

# Board Name
IP8100_DIR857_BOARD = 1
...
# U-Boot Path
APP_UBOOT_DIR = /home/twu/work/ubicom-distro-3.0/u-boot
