 ...
 */
void md5_create_digest( unsigned char *input, int ilen, unsigned char *output )
{
    md5_context ctx;
...
void md5_hmac_starts( md5_context *ctx, unsigned char *key, int keylen )
{
    ...
    if( keylen > 64 )
    {
        md5_create_digest( key, keylen, sum );
        keylen = 16;
        key = sum;
    }
...
int md5_self_test( int verbose )
{
    ...
    for( i = 0; i < 7; i++ )
    {
        ...
        md5_create_digest( (unsigned char *) md5_test_str[i],
