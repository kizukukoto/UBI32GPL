...
static const struct ubicom32vfb_lcd_step cfaf240320ktts_init_0[] = {
...
static const struct ubicom32vfb_lcd_step cfaf240320ktts_init_180[] = {
	{LCD_STEP_CMD_DATA, 0x0001, 0x0000,}, // Driver Output Control Register (R01h)		Page 14, SPFD5408B Datasheet 
	{LCD_STEP_CMD_DATA, 0x0002, 0x0700,}, // LCD Driving Waveform Control (R02h)		Page 15, SPFD5408B Datasheet 
...
static const struct ubicom32vfb_lcd_step tft2n0369e_land_init[] = {
	...
	/*	Date:	2009-11-23
	*	Name:	jimmy huang
	*	Reason:	To rotate LCD image 180 degree
	*	Note:	On behalf of Ubicom FAE clark's
	*			Combination of RL and TB have the output at the degree you need.
	*			Data sheet reference for LCD driver SSD 1289 is available at
	*			http://www.trulydisplays.com/tft/driveric/Driver%20IC%20SSD1289.pdf
	*			page 27
	*/
	//{LCD_STEP_CMD_DATA, 0x0001, 0x2B3F},
	{LCD_STEP_CMD_DATA, 0x0001, 0x693F},
...
static const struct ubicom32vfb_lcd_step tft2n0369e_port_init[] = {
	{LCD_STEP_CMD_DATA, 0x0028, 0x0006},
	{LCD_STEP_CMD_DATA, 0x0000, 0x0001},
	{LCD_STEP_SLEEP, 0, 15},
	{LCD_STEP_CMD_DATA, 0x002B, 0x9532},
...
static const struct ubicom32vfb_lcd_step cfaf240400d_init[] = {
...
static const struct ubicom32vfb_lcd_step cfaf320240f_init[] = {
...
const struct ubicom32vfb_lcd_panel cfaf240320ktts_0 = {
	.desc		= "CFAF240320KTTS",
	...
	.id		= 0x5408,
	.delay		= (3 << 16) | 0,
	.flags		= UBICOM32VFB_LCD_PANEL_FLAG_NO_PARTIAL,
};

const struct ubicom32vfb_lcd_panel cfaf240320ktts_180 = {
...
const struct ubicom32vfb_lcd_panel cfaf240400d = {
	.desc		= "CFAF240400D",
...
const struct ubicom32vfb_lcd_panel tft2n0369e_port_8bit = {
	.desc		= "TFT2N0369E-8BIT (Portrait)",
	.init_seq	= tft2n0369e_port_init,
	.horz_reg	= 0x4e,
	.vert_reg	= 0x4f,
	.gram_reg	= 0x22,
	.xres		= 240,
	...
	.id		= 0x8989,
	.delay		= (3 << 16) | 3,
	.flags		= UBICOM32VFB_LCD_PANEL_FLAG_8BIT,
};

const struct ubicom32vfb_lcd_panel tft2n0369e_port = {
...
const struct ubicom32vfb_lcd_panel tft2n0369e_land = {
	.desc		= "TFT2N0369E (Landscape)",
	.init_seq	= tft2n0369e_land_init,
	.horz_reg	= 0x4e,
	.vert_reg	= 0x4f,
	.gram_reg	= 0x22,
	.xres		= 320,
	...
	.id		= 0x8989,
	.delay		= (3 << 16) | 3,
	.flags		= UBICOM32VFB_LCD_PANEL_FLAG_ROTATED | UBICOM32VFB_LCD_PANEL_FLAG_FLIPX,
};

const struct ubicom32vfb_lcd_panel tft2n0369e_land_8bit = {
	.desc		= "TFT2N0369E-8BIT (Landscape)",
	.init_seq	= tft2n0369e_land_init,
	.horz_reg	= 0x4e,
	.vert_reg	= 0x4f,
	.gram_reg	= 0x22,
	...
	.id		= 0x8989,
	.delay		= (3 << 16) | 3,
	.flags		= UBICOM32VFB_LCD_PANEL_FLAG_ROTATED | UBICOM32VFB_LCD_PANEL_FLAG_FLIPX | UBICOM32VFB_LCD_PANEL_FLAG_8BIT,
};

const struct ubicom32vfb_lcd_panel cfaf320240f = {
	.desc		= "CFAF320240F",
...
const struct ubicom32vfb_lcd_panel *ubicom32vfb_lcd_panels[] = {
	&cfaf240320ktts_0,
	&cfaf240400d,
	&tft2n0369e_land,
	&tft2n0369e_port,
	&tft2n0369e_land_8bit,
	&tft2n0369e_port_8bit,
	&cfaf320240f,
	NULL,
};
