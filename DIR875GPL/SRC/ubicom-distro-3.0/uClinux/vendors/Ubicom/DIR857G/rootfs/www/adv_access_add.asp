...
<body topmargin="1" leftmargin="0" rightmargin="0" bgcolor="#757575">
	...
	<table border="1" cellpadding="2" cellspacing="0" width="838" height="100%" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
		<tr>
			...
			<div id=maincontent>
            <div class=box>
            <h2><script>show_words(_aa_wiz_s1_title)</script>
            </h2>

            <P class="box_msg">
              <script>show_words(_aa_wiz_s1_msg)</script>
            </P>
				<table width="670" class=formarea>
                  ...
                  <td>
                    <script>show_words(aa_wiz_s1_msg1)</script>
                  </td>
					  </tr>
					  <tr>

                  <td>
                    <script>show_words(aa_wiz_s1_msg2)</script>
                  </td>
					  </tr>
					  <tr>

                  <td>
                    <script>show_words(aa_wiz_s1_msg3)</script>
                  </td>
					  </tr>
					  <tr>

                  <td>
                    <script>show_words(aa_wiz_s1_msg4)</script>
                  </td>
					  </tr>
					  <tr>

                  <td>
                    <script>show_words(aa_wiz_s1_msg5)</script>
                  </td>
					  </tr>
					  <tr>

                  <td>
                    <script>show_words(aa_wiz_s1_msg6)</script>
                  </td>
					  </tr>
				  </tbody>
				</table><hr>
