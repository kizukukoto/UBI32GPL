...
var phy_or_wan="";
		var real_wan_ip = xmlhttp.responseXML.getElementsByTagName("wan_ip")[0].firstChild.nodeValue;

		if( ( (get_by_id("wan_pptp_russia_enable").value=="1") || (get_by_id("wan_l2tp_russia_enable").value=="1") || (get_by_id("wan_pppoe_russia_enable").value=="1") ) && (real_wan_ip == "0.0.0.0"))
			phy_or_wan = "phy_";
        d = get_by_id("wan_ip");
