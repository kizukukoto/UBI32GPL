				...
				<td width="331">&nbsp;<b>
					...
					<input type=text id="ipv6_6rd_prefix_length" name="ipv6_6rd_prefix_length" size="5" maxlength="2" value="<% CmoGetCfg("ipv6_6rd_prefix_length",""); %>" onChange="ipv6_6rd_prefix_onchange()">
	                    ...
	                    <tr>
                              ...
                              <td width="331">&nbsp;<b><span id="wan_ip"></span></b>&nbsp;&nbsp;&nbsp;<b><script>show_words(IPV6_6rd_mask);</script> :</b><input type=text id="ipv6_6rd_ipv4_mask_length" name="ipv6_6rd_ipv4_mask_length" size="5" maxlength="2" value="<% CmoGetCfg("ipv6_6rd_ipv4_mask_length",""); %>" onChange="ipv6_6rd_prefix_onchange()"></td>
                            </tr>
                            <tr>
