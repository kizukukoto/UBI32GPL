...
var default_isp_list = new Array(new isp_obj("--None--", "", "", "", ""),
							new isp_obj("Telstra", "*99#", "telstra.internet", "", ""),//Australia
							new isp_obj("Optus", "*99#", "Internet", "", ""),//Australia
							new isp_obj("Bigpond", "*99**#", "telstra.bigpond", "", ""),//Australia
							new isp_obj("Hutchison 3G", "*99***1#", "3netaccess", "", ""),//Australia
							new isp_obj("Vodafone", "*99***1#", "vfinternet.au", "", ""),//Australia
							new isp_obj("Rogers", "", "internet.com", "wapuser1", "wap"),//Canada
							new isp_obj("Comcel", "*99#", "internet.comcel.com.co", "comcelweb", "comcelweb"),//Colombia
							new isp_obj("3", "*99***1#", "data.tre.dk", "", ""),//Denmark
							new isp_obj("TDC", "*99***1#", "internet", "", ""),//Denmark
							new isp_obj("SFR", "*99#", "websfr", "", ""),//France
							new isp_obj("Celcom", "*99***1#", "celcom3g", "", ""),//Malaysia
							new isp_obj("Maxis", "*99***1#", "unet", "maxis", "wap"),//Malaysia
							new isp_obj("Red Tone", "*99#", "redtone", "", ""),//Malaysia
							new isp_obj("U-Mobile", "*99#", "my3g", "", ""),//Malaysia								
							new isp_obj("Brasil Telecom", "*99***1#", "brt.br", "brt", "brt"),//Brazil
							new isp_obj("CTBC", "*99#", "ctbc.br", "ctbc", "ctbc"),//Brazil
							new isp_obj("Claro", "*99***1#", "bandalarga.claro.com.br", "claro", "claro"),//Brazil
							new isp_obj("Oi", "*99#", "gprs.oi.com.br", "", ""),//Brazil																												
							new isp_obj("Sercomtel", "*99#", "sercomtel.com.br", "sercomtel", "sercomtel"),//Brazil	
							new isp_obj("TIM", "*99#", "tim.br", "tim", "tim"),//Brazil	
							new isp_obj("Vivo", "*99#", "zap.vivo.com.br", "vivo", "vivo"),//Brazil	
							new isp_obj("DNA / Finnet", "*99***1#", "internet", "", ""),//Finland
							new isp_obj("Elisa", "*99***1#", "internet", "", ""),//Finland
							new isp_obj("Saunalahti", "*99***1#", "internet.saunalahti", "", ""),//Finland
							new isp_obj("Sonera", "*99***1#", "prointernet", "", ""),//Finland																												
							new isp_obj("Vodafone", "*99#", "web.vodafone.de", "", "ADMIN"),//Germany	
							new isp_obj("Cellcom", "*99#", "internetg", "", ""),//Israel	
							new isp_obj("Orange", "*99#", "uinternet", "", "ADMIN"),//Israel								
							new isp_obj("Safaricom", "*99#", "safaricom", "saf", "data"),//Mauritius	
							new isp_obj("EMTEL", "", "", "", ""),//Kenya
							new isp_obj("Telcel", "*99#", "Internet.itelcel.com", "webgprs", "webgprs2002"),//Mexico
							new isp_obj("Netcom", "*99#", "internet.netcom.no", "", ""),//Norway
							new isp_obj("Telenor", "*99#", "telenor", "", ""),//Norway																								
							new isp_obj("AT&T", "*99***1#", "proxy", "", ""),//USA
							new isp_obj("AT&T", "*99***1#", "isp.cingular", "", ""),//USA
							new isp_obj("Italy", "", "Telecom Italia Mobile", "", ""),//Italy
							new isp_obj("Portugal", "", "Optimus", "", ""),//Portugal
							new isp_obj("Claro PY", "*99#", "gprs.claro.com.py", "clarogprs", "clarogprs999"),//Paraguay
							new isp_obj("Claro/CTI", "*99#", "internet.ctimovil.com.py", "ctigprs", "ctigprs999"),//Paraguay
							new isp_obj("Telecel", "*99***1#", "broadband.tigo.py", "tigo", "tigo"),//Paraguay							
							new isp_obj("Era", "*99#", "erainternet", "erainternet", "erainternet"),//Poland
							new isp_obj("Orange", "*99#", "internet", "internet", "internet"),//Poland
							new isp_obj("Plus", "*99#", "internet", "", ""),//Poland
							new isp_obj("Tele2/Comviq", "*99#", "internet.tele2.se", "", ""),//Finland
							new isp_obj("Telenor", "*99#", "internet.telenor.se", "", ""),//Finland
							new isp_obj("Telia", "*99#", "online.telia.se", "", ""),//Finland
							new isp_obj("Tre", "*99#", "bredband.tre.se", "", ""),//Finland										
							new isp_obj("AIS", "*99#", "internet", "", ""),//Thailand								
							new isp_obj("Orangenet", "", "orangenet", "", ""),//UK
							new isp_obj("Vodafone", "", "", "", ""),//UK
							new isp_obj("O2", "", "", "", ""),//UK
							new isp_obj("T-mobile", "", "", "", ""),//UK
							new isp_obj("IM2", "*99#", "indosatm2", "", ""),//Indonesia
							new isp_obj("INDOSAT", "*99#", "indosat3g", "indosat", "indosat"),//Indonesia
							new isp_obj("XL", "*99#", "www.xlgprs.net", "xlgprs", "proxl"),//Indonesia
							new isp_obj("Telkomsel Flash", "*99#", "flash", "", ""),//Indonesia
							new isp_obj("3", "*99***1#", "3gprs", "3gprs", "3gprs"),//Indonesia
							new isp_obj("Malaysia", "*99***1#", "celcom3g", "", ""),//Malaysia
							new isp_obj("Maxis", "*99***1#", "unet", "maxis", "wap"),//Malaysia
							new isp_obj("M1", "*99***1#", "sunsurf", "", ""),//Singapore
							new isp_obj("Singtel", "*99***1#", "e-ideas", "", ""),//Singapore
							new isp_obj("StarHub", "*99***1#", "", "", ""),//Singapore
							new isp_obj("Power Grid", "*99***1#", "", "", ""),//Singapore
							new isp_obj("Globe", "*99***1#", "internet.globe.com.ph", "", ""),//Philippine
							new isp_obj("Vodacom", "", "", "", ""),//South Africa
							new isp_obj("MTN", "", "", "", ""),//South Africa
							new isp_obj("SmarTone-Vodafone", "*99***1#", "internet", "", ""),//HongKong
							new isp_obj("3 Hong Kong", "*99***1#", "mobile.three.com.hk", "", ""),//HongKong
							new isp_obj("One2Free", "*99***1#", "internet", "", ""),//HongKong
							new isp_obj("PCCW mobile", "*99#", "pccw", "", ""),//HongKong
							new isp_obj("All 3G ISP support", "*99***1#", "", "", ""),//HongKong
							new isp_obj("Far Eastern", "*99#", "internet", "", ""),//Taiwan
							new isp_obj("Chunghua Telecom", "*99***1#", "internet", "", ""),//Taiwan
							new isp_obj("Taiwan Mobile", "*99#", "internet", "", ""),//Taiwan
							new isp_obj("Vibo", "*99#", "vibo", "", ""),//Taiwan
							new isp_obj("Etisalat", "*99***1#", "internet", "", ""),//Egypt
							new isp_obj("Telmex", "*99#", "internet.ideasclaro.com.do", "claro", "claro"),//Dominican Republic
							new isp_obj("Telmex", "*99#", "internet.ideasclaro", "", ""),//El Salvador
							new isp_obj("Claro", "*99***1#", "bandalarga.claro.com.br", "claro", "claro") //Brasil
	);
...
var key_len_error = new Array(MSG016,
							  MSG017
							   );

var illegal_key_error = new Array(TEXT042_1,
								  TEXT076,
								  TEXT076,
								  TEXT076								 
								  );
