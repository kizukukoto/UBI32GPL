...
<script language=JavaScript>
    ...
    function onPageLoad()
    {
        ...
        set_checked("<% CmoGetCfg("ipv6_multicast_stream_enable","none"); %>", get_by_id("ipv6_multi_enable"));
    ...
    <table border="1" cellpadding="2" cellspacing="0" width="838" align="center" bgcolor="#FFFFFF" bordercolordark="#FFFFFF">
        ...
        <h2>
		  ...
		  <div class=box id=ipv6_multicast>
			...
			<input type="hidden" id="ipv6_multicast_stream_enable" name="ipv6_multicast_stream_enable" value="<% CmoGetCfg("ipv6_multicast_stream_enable","none"); %>">
			</td>
              </tr>
            </table>
            </div>
