...
static void tcp_v4_send_reset(struct sock *sk, struct sk_buff *skb)
{
	...
	// Jerry add 2010/10/22
	// Fixed tcp port scan fail in port 0 and 1 by using www.grc.com/default.htm test tool
	// if (dest port is 0 or 1 and all flags is zero) then return
	if ( (th->dest==0 || th->dest==1) && 
