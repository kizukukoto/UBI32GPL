...
static struct hostapd_iface * hostapd_init(const char *config_file)
{
	...
	wpa_printf(MSG_CAMEO, "CAMEO: hostapd_init: start");
	...
	wpa_printf(MSG_CAMEO, "CAMEO: hostapd_init: hostapd_config_read");
...
fail:
	wpa_printf(MSG_CAMEO, "CAMEO: hostapd_init: fail");	
	if (conf)
...
{
	wpa_printf(MSG_CAMEO, "CAMEO: hostapd_global_init: start");
...
int main(int argc, char *argv[])
{
	...
	wpa_printf(MSG_CAMEO, "CAMEO: hostapd: main");
	...
	wpa_printf(MSG_CAMEO, "CAMEO: hostapd main: hostapd_global_run");
