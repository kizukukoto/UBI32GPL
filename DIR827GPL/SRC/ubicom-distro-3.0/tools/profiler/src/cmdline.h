...
public:
	...
	int next_lib_path;
	void usage(void) {
		AfxMessageBox("Usage: ubicom32-prof [-t:run_for_seconds [-no_gui]] [-S[:max_run_seconds]] [-log[:seconds_per_log_entry]] [-ip:board-ip-address] [-D:distro_path] [-a] [-lib:library_path] [ultra-elf-file linux-elf-file] [application-or-library-elf-file] ...\n\t -or- ubicom32-prof saved_file.pgr");
	}
