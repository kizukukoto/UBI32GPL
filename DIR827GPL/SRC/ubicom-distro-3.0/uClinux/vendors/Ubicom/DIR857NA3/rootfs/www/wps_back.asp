...
<tr>
  <td bgcolor="#FFFFFF">    <div align="center">
    ...
    <tr>
      <td width="50%"><div id=box_header>
        ...
        <p>&nbsp;</p>
        <p align="center"><script>show_words(wps_messgae1_2)</script> <font color="#FF0000"><span id="show_sec"></span></font>&nbsp;<script>show_words(_seconds)</script> &hellip;</p>
  		<p>&nbsp;</p>
      </div>
      </td>
    </tr>
  ...
  <script>
if(wps_status == "1"){
		window.location.href = "wps_back_result.asp";
}
