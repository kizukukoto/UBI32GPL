...
var reboot_needed = "<% CmoGetStatus("reboot_needed"); %>";
	...
	function change_wep_key_fun(){
       ...
       get_by_id("wlan0_wep64_key_1").value = key64_ps.substring(0, 10);
		...
		get_by_id("examine_key1").value = key1;
	...
	function send_request(){
		get_by_id("examine_key1").value = get_by_id("key1").value;
...
*/
    ...
    function add_channel() {
        ...
        var region = "<% CmoGetCfg("wlan0_domain","none"); %>";
        /* The list domain channels have 140 and 165 channel */
        var domain = new Array("0x10", "0x14", "0x23", "0x3C", "0x3A", "0x3B", "0x50", "0x52", "0x5B", "0x37");
        ...
        for (var i = 0; i < domain.length; i++) {
                if (region == domain[i]) {
                        ...
                        if (protection == "auto") {
                                ...
                                if (t_channel == "136" ) {
                                        try {
                                                obj.add(new Option("140", len+1), null);
                                                obj[len+1].value = 140;
                                        } catch(e) {
                                                obj.add(new Option("140", len+1));
                                                obj[len+1].value = 140;
                                        }
                                        ...
                                        try {
                                                obj.add(new Option("165", len+1), null);
                                                obj[len+1].value = 165;
                                        } catch(e) {
                                                obj.add(new Option("165", len+1));
                                                obj[len+1].value = 165;
                                        }
                                }
                        }
        ...
        <div class="box" id="show_wep" style="display:none"> 
          ...
          <table cellpadding="1" cellspacing="1" border="0" width="525">
            ...
            <tr>
              ...
              <td width="340">&nbsp; <span id="show_resert1"></span><input type="hidden" id="examine_key1"></td>
            </tr>
