...
var GW_WISH_RULES_DUPLICATED="Record '%s' is duplicate of '%s'.";
...
var help401_b="If NetBIOS advertisement is switched on, switching this setting on causes WINS information to be learned from the WAN side, if available.";
...
var KR18="Enter an 8- to 63-character alphanumeric pass-phrase. For good security it should be of ample length and should not be a commonly known phrase.";
...
var IPV6_TEXT21="%s supports two different cipher types when WPA is used as the Security Type. These two options are TKIP (Temporal Key Integrity Protocol) and AES (Advanced Encryption Standard).";
...
var IPV6_TEXT25="This will be needed by your wireless clients in order to communicate with your %m, when PSK is selected. Enter 8 to 63 alphanumeric characters. Be sure to write this Passphrase down as you will need to enter it on any other wireless devices you are trying to add to your network.";
...
var tool_admin_check="Please check";
var ss_WStats_0="WI-FI Statistics 2.4GHZ";
var ss_WStats_1="WI-FI Statistics 5GHZ";
