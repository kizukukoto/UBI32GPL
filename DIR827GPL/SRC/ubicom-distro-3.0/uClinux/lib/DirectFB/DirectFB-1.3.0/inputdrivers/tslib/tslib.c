                    ...
                    void            **driver_data )
{
     ...
     info->desc.min_keycode = DIKS_CUSTOM99;
     info->desc.max_keycode = DIKS_CUSTOM99;
                         ...
                         DFBInputDeviceKeymapEntry *entry )
{
	...
	if (entry->code != DIKS_CUSTOM99) {
		return DFB_UNSUPPORTED;
	}

	D_DEBUG("Reset touch screen driver\n");

	/*
	 * Use this function to trigger a re-read
	 */
	ts_reset(data->ts, 0);
