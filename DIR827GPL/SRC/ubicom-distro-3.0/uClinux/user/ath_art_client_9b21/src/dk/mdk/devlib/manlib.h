...
typedef struct DeviceMap {
	...
	A_UINT_PTR DEV_REG_ADDRESS;    // Base location of register access functions
	A_UINT32 DEV_REG_RANGE;      // Range in bytes for memory access
	A_UINT_PTR DEV_CFG_ADDRESS;    // Base location of PCIconfig access functions
	...
	A_UINT32 (* OSregRead)(A_UINT32 devNum, A_UINT_PTR address);
	void (* OSregWrite)(A_UINT32 devNum, A_UINT_PTR address, A_UINT32 regValue);   
...
MANLIB_API void rxDataCompleteFixedNumber_1(A_UINT32 devNum, A_UINT32 timeout, A_UINT32 remoteStats,
				A_UINT32 enableCompare, A_UCHAR *dataPattern, A_UINT32 dataPatternLength,A_CHAR *GIVEN_SSID);
MANLIB_API A_INT32 checkBeaconRSSI(A_UINT32 devNum, A_UINT32 timeout, A_UINT32 remoteStats,A_UINT32 enableCompare, A_UCHAR *dataPattern, A_UINT32 dataPatternLength,A_CHAR *GIVEN_SSID,A_INT32 rssiThreshold,A_INT32 rssi_delta,A_UINT16 antenna,A_INT32* result);
