...
int wz_welcome_ui_1(LiteWindow *win, wizard_page **p)
{
	int i = 0;
	struct {
		DFBRectangle rect;
...
int wz_welcome_evt_1(LiteWindow *win, wizard_page **p)
{
	return option_return_click(win, PAGE_NOTHANKS | PAGE_BEGIN);
}

int wz_welcome_ui_2(LiteWindow *win, wizard_page **p)
{
	int i = 0;
...
int wz_welcome_evt_2(LiteWindow *win, wizard_page **p)
{
