...
extern void ms_advanced_handler(DFBWindowEvent *evt);
extern int bt_ripple_handler(int x, int y, DFBRegion *rg, int nr);
extern DFBResult set_mouse_advanced_flag(bool);
#endif
