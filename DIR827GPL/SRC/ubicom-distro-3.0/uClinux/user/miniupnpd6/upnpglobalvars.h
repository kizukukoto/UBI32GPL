...
extern const char * linklocal_ip_addr;
extern int linklocal_index;
...
extern int upnp_bootid;
extern int upnp_configid;
//extern int upnp_searchport;
//extern int upnp_next_bootid;
// **

extern const char * pidfilename;

extern char uuidvalue[256];
extern char wandevuuid[256];
extern char wanconuuid[256];
...
#define ST_MAX_LEN (54)
extern char IGDstname[];
...
extern int firewallEnabled;
extern int inboundPinholeAllowed;
extern int inboundPinholeSpace;
extern int systemUpdateID;
extern char nextpinholetoclean_uid[];
extern unsigned int nextpinholetoclean_timestamp;
extern int ip_version;


extern char tmp_char_1[];
extern char tmp_char_2[];
extern int count_1;
extern int count_2;

extern const char * rulefilename;
extern int line_number;
//#define UUID_GEN_FILE_6 "/var/tmp/uuid_file_6"
#define UUID_GEN_FILE_6 "/var/tmp/uuid_file"
#endif
