...
#define FLAG_NEED_FACTORY_RESET "/etc/tr/FLAG_NEED_FACTORY_RESET"
#define FLAG_BOOTSTRAP "/etc/tr/FLAG_BOOTSTRAP"
#define FLAG_ACS_URL_CHANGED "/etc/tr/FLAG_ACS_URL_CHANGED"

#endif

#define FILE_PATH_LEN	128
#define NODE_PATH_LEN	128
